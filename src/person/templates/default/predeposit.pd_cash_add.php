...
请填写详细的开户银行分行名称，虚拟账户如支付宝、财付通填写“支付宝”、“财付通”即可。</p>
      ...
      <dl>
        ...
        <p class="hint">
              ...
              <strong class="red">还未设置支付密码</strong><a href="index.php?model=member_security&fun=auth&type=modify_paypwd" class="ncbtn-mini ncbtn-aqua vm ml10" target="_blank">马上设置</a>
              <?php } ?>
        </p>
          </dd>
      </dl>
