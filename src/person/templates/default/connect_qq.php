...
<div class="nc-login-layout">
  <div class="openid"><span class="avatar"><img src="<?php echo $output['qquser_info']['figureurl_qq_1'];?>" /></span><span>您使用QQ账号<a href="#register_form"><?php echo $output['qquser_info']['nickname']; ?></a>Registered successfully，系统为您随机新建商城用户名<br/>
    ...
    <div class="nc-qq-mode">
      ...
      <div id="tabs_container" class="tabs-container">
        <div id="register" class="tabs-content">
          <form name="register_form" id="register_form" class="nc-login-form" method="post" action="index.php?model=connect_qq&fun=register">
