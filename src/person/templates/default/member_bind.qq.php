...
<div class="wrap">
  ...
  <div class="ncm-bind">
    ...
    <div class="relieve">
      <form method="post" id="editbind_form" name="editbind_form" action="index.php?model=member_bind&fun=qqunbind">
    ...
    <div class="revise ncm-default-form ">
      <form method="post" id="editpw_form" name="editpw_form" action="index.php?model=member_bind&fun=qqunbind">
    ...
    <div class="relieve pt50">
      <p class="ico"><a href="<?php echo MEMBER_SITE_URL;?>/index.php?model=connect_qq"><img src="<?php echo MEMBER_TEMPLATES_URL;?>/images/qq_bind_small.gif"></a>
