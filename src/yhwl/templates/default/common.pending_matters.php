...
<ul class="cp-toast-list">
  ...
  <li>
    ...
    <span>[商城-留言]</span>
    <a target="workspace" href="<?php echo urlAdminshop('store', 'store_joinin');?>" onclick="openItem('shop|store')"><i class="fa fa-bell-o"></i>有<strong><?php echo $output['statistics']['store_joinin'];?></strong>条留言申请需要处理。</a>
  </li>
  <?php }?>
 ...
 <!--  <li>
  ...
  <?php }?>
  <?php if ($output['statistics']['repaid']) {?>
  <li>
    <span>[商城-交易]</span>
    <a target="workspace" href="javascript:void(0);" onclick="openItem('shop|repaid')"><i class="fa fa-bell-o"></i>有<strong><?php echo $output['statistics']['repaid'];?></strong>个商品报修申请需要处理。</a>
  </li>
  <?php }?>
