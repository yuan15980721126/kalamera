      ...
      <?php } ?>
        <?php if ($output['payment']['payment_code'] == 'PayPal') { ?>
            <dl class="row">
                ...
                <dd class="opt">
                    <input name="paypal_name" id="paypal_name" value="<?php echo $output['payment']['payment_config']['paypal_name'];?>" class="input-txt" type="text">
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            <dl class="row">
                ...
                <dd class="opt">
                    <input name="paypal_key" id="paypal_key" value="<?php echo $output['payment']['payment_config']['paypal_key'];?>" class="input-txt" type="text">
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            <dl class="row">
                ...
                <dd class="opt">
                    <input name="paypal_sign" size="60" id="paypal_sign" value="<?php echo $output['payment']['payment_config']['paypal_sign'];?>" class="input-txt" type="text">
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
