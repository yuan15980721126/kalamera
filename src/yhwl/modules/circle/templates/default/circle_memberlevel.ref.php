  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        <li><a href="index.php?model=circle_memberlevel"><?php echo $lang['circle_defaultlevel'];?></a></li>
    ...
    <table class="flex-table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="handle"><a href="javascript:void(0);" onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){location.href='index.php?model=circle_memberlevel&fun=ref_del&mlref_id=<?php echo $val['mlref_id'];?>'}" class="btn red"><i class="fa fa-trash-o"></i><?php echo $lang['nc_del'];?></a><a href="index.php?model=circle_memberlevel&fun=ref_edit&mlref_id=<?php echo $val['mlref_id'];?>" class="btn blue"><i class="fa fa-pencil-square-o"></i><?php echo $lang['nc_edit'];?></a></td>
...
function fg_operation(name, bDiv) {
    if (name == 'add') {
        window.location.href = 'index.php?model=circle_memberlevel&fun=ref_add';
    }
}
</script>
