...
class cms_specialControl extends SystemControl{
    ...
    const LINK_CMS_SPECIAL = 'index.php?model=cms_special&fun=cms_special_list';
    //专题状态草稿箱
        ...
        if (!empty($list) && is_array($list)){
            ...
            foreach ($list as $k => $v){
                ...
                if($v['special_state'] == '2') {
                    ...
                    $operation .= '<li><a href="index.php?model=cms_special&fun=cms_special_detail&special_id='.$v['special_id'].'" target="_blank">预览专题页面</a></li>';
                }
                $operation .= '<li><a href="index.php?model=cms_special&fun=cms_special_edit&special_id='.$v['special_id'].'">编辑专题内容</a></li>';
                $operation .= '</ul></span>';
...
Tpl::showpage('cms_special.detail', 'null_layout');
    ...
    private function show_menu($menu_key) {
        $menu_array = array(
            'special_list'=>array('menu_type'=>'link','menu_name'=>Language::get('nc_manage'),'menu_url'=>'index.php?model=cms_special&fun=cms_special_list'),
            'special_add'=>array('menu_type'=>'link','menu_name'=>Language::get('nc_new'),'menu_url'=>'index.php?model=cms_special&fun=cms_special_add'),
