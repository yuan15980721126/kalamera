    ...
    <div class="ncap-form-default">
      ...
      <?php
				 	...
				 	case '0':
						...
						echo "<dl class='row'>
								<dt class='tit'>
									<label for='ap_url_input'><em>*</em>".$lang['ap_height_url']."</label>
								</dt>
								<dd class='opt'>
									<input type='text' value='".$v['adv_url']."' name='ap_url' id='ap_url_input' class='input-txt'>
									<span class='err'></span>
						...
						echo "<dl class='row'>
								<dt class='tit'>
									<label for='ap_sort_input'><em>*</em>".$lang['ap_sort']."</label>
								</dt>
								<dd class='opt'>
									<input type='text' value='".$v['sort']."' name='ap_sort' id='ap_sort_input' class='input-txt'>
									<span class='err'></span>
