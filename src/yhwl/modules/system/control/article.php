    ...
    public function get_xmlOp(){
        ...
        if (is_array($article_list)){
            ...
            foreach ($article_list as $k => $v){
                $list = array();
                $list['operation'] = "<a class='btn red' onclick=\"fg_delete({$v['article_id']})\"><i class='fa fa-trash-o'></i>删除</a><a class='btn blue' href='index.php?model=article&fun=article_edit&article_id={$v['article_id']}'><i class='fa fa-pencil-square-o'></i>编辑</a>";
                ...
                $list['article_desc'] = $v['article_desc'];
...
//                 array("input"=>$_POST["article_content"], "require"=>"true", "message"=>$lang['article_add_content_null']),
            ...
            if ($error != ''){
                ...
                $insert_array['article_desc'] = trim($_POST['article_desc']);
                ...
                if ($result){
                    ...
                    $url = array(
                        array(
                            'url'=>'index.php?model=article&fun=article',
                            'msg'=>"{$lang['article_add_tolist']}",
                        ),
                        array(
                            'url'=>'index.php?model=article&fun=article_add&ac_id='.intval($_POST['ac_id']),
...
//                 array("input"=>$_POST["article_content"], "require"=>"true", "message"=>$lang['article_add_content_null']),
            ...
            if ($error != ''){
                ...
                $update_array['article_desc'] = trim($_POST['article_desc']);
                ...
                if ($result){
                    ...
                    $url = array(
                        ...
                        array(
                            'url'=>'index.php?model=article&fun=article_edit&article_id='.intval($_POST['article_id']),
