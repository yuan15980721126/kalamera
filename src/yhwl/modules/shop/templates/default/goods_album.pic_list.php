...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?model=goods_album&fun=list" title="返回<?php echo $lang['g_album_list'];?>"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
...
$(function(){
	...
	$('a[nc_type="delete"]').bind('click',function(){
		...
		cur_note = this;
		$.get("index.php?model=goods_album&fun=del_album_pic", {'key':$(this).attr('nc_key')}, function(data){
            if (data == 1) {
