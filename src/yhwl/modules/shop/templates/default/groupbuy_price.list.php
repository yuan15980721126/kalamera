...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?model=groupbuy&fun=price_list_xml',
        colModel: [
        ...
        buttons: [
            {
                ...
                title: '添加一条新数据到列表',
                onpress: function() {
                    location.href = 'index.php?model=groupbuy&fun=price_add';
                }
            },
            {
                ...
                onpress: function() {
                    ...
                    location.href = 'index.php?model=groupbuy&fun=price_drop&range_id=' + ids.join(',');
                }
            }
        ],
        usepager: false,
