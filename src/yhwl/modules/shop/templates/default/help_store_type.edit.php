...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?model=help_store&fun=help_type" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
  ...
  <form id="post_form" method="post" name="form1" action="index.php?model=help_store&fun=edit_type&type_id=<?php echo $output['type']['type_id']; ?>">
