    ...
    <div class="tabs-panels">
      <div class="misc-info">
        <dl>
          ...
          <dd><a href="index.php?model=order&fun=show_order&order_id=<?php echo $output['order_info']['order_id'];?>"> <?php echo $output['order_info']['order_sn'];?></a></dd>
          ...
          <tfoot>
            <tr>
              <td colspan="100">&nbsp;&nbsp;<?php echo $lang['complain_content'];?>
                <div class="complain-intro"><?php echo $output['complain_info']['complain_content'];?></div></td>
            </tr>
          </tfoot>
        </table>
      </div>
      ...
      <dd class="opt">
        <?php
                        if(empty($output['complain_info']['complain_pic1'])&&empty($output['complain_info']['complain_pic2'])&&empty($output['complain_info']['complain_pic3'])) {
                            ...
                            $pic_link = 'index.php?model=show_pics&type=complain&pics=';
...
function get_complain_talk() {
    ...
    $.ajax({
        type:'POST',
        url:'index.php?model=complain&fun=get_complain_talk',
        cache:false,
...
function publish_complain_talk() {
        $.ajax({
            type:'POST',
                url:'index.php?model=complain&fun=publish_complain_talk',
                cache:false,
...
function forbit_talk(talk_id) {
        $.ajax({
            type:'POST',
                url:'index.php?model=complain&fun=forbit_talk',
                cache:false,
  ...
  <div class="ncap-form-default">
    ...
    <dl class="row" id="close_complain">
      ...
      <form method='post' id="verify_form" action="index.php?model=complain&fun=complain_verify">
    ...
    <form method='post' id="close_form" action="index.php?model=complain&fun=complain_close">
