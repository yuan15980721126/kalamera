...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?model=member&fun=member" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
  ...
  <form id="user_form" enctype="multipart/form-data" method="post">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" value="<?php echo $output['member_array']['member_exppoints']; ?>" id="member_exppoints" name="member_exppoints" class="input-txt" size="7" style="width:60px!important;">&nbsp;经验点

        <!-- <strong class="red"><?php echo $output['member_array']['member_exppoints']; ?></strong>&nbsp;经验点  -->
        </dd>
      </dl>
     <!--  <dl class="row">
        <dt class="tit">
