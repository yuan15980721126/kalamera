...
<?php $newParams = unserialize($output['joinin_detail']['leave_message']); ?>
<div class="page">
  <div class="fixed-bar">
  ...
  <form id="form_store_verify" action="index.php?model=store&fun=store_joinin_verify" method="post">
  <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
    ...
    <tbody>
      ...
      <tr>
          <th class="w150">申请留言：</th>
          <td><?php echo $output['joinin_detail']['jiameng_message'];?></td>
      </tr>
      <?php if($newParams){   ?>
      <tr>
        <th class="w150">First name：</th>
        <td><?php echo $newParams['first_name'];?></td>
      </tr>
      <tr>
        <th class="w150">Last name：</th>
          <td><?php echo $newParams['last_name'];?></td>
      </tr>
      <tr>
        <th class="w150">州或省：</th>
          <td><?php echo $newParams['province'];?></td>
      </tr>
      <tr>
        <th class="w150">城市：</th>
          <td><?php echo $newParams['city'];?></td>
      </tr>
      <tr>
        <th class="w150">邮政编码：</th>
          <td><?php echo $newParams['code'];?></td>
      </tr>
      <tr>
          <th class="w150">1.Do you have an order number?：</th>
          <td><?php echo $newParams['info1'];?></td>
      </tr>
      <tr>
          <th class="w150">2.Where did you purchase from?：</th>
          <td><?php echo $newParams['info2'];?></td>
      </tr>
      <tr>
          <th class="w150">3.What is the model number?：</th>
          <td><?php echo $newParams['info3'];?></td>
      </tr>
      <tr>
          <th class="w150">4.When did you purchase the item?：</th>
          <td><?php echo $newParams['info4'];?></td>
      </tr>
      <?php } ?>
      <tr>
        <th class="w150">申请时间：</th>
        <td><?php echo date("Y-m-d H:i:s",$output['joinin_detail']['jiameng_time']);?></td>
      </tr>
