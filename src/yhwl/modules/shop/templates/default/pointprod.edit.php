...
//
    ...
    $('#fileupload').each(function(){
        $(this).fileupload({
            dataType: 'json',
            url: 'index.php?model=pointprod&fun=pointprod_pic_upload&item_id=<?php echo $output['prod_info']['pgoods_id']; ?>',
...
function del_file_upload(file_id)
{
    ...
    $.getJSON('index.php?model=pointprod&fun=ajaxdelupload&file_id=' + file_id, function(result){
        if(result){
            $('#' + file_id).remove();
        }else{
