...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?model=ownshop&fun=list" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
    ...
    $('#store_form').validate({
        ...
        rules : {
            ...
            member_name: {
                ...
                maxlength : 15,
                remote   : {
                    url : 'index.php?model=ownshop&fun=check_member_name',
                    type: 'get',
                    data:{
            ...
            seller_name: {
                ...
                maxlength : 15,
                remote   : {
                    url : 'index.php?model=ownshop&fun=check_seller_name',
                    type: 'get',
                    data:{
