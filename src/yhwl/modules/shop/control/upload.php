...
class uploadControl extends SystemControl{
    private $links = array(
        array('url'=>'model=upload&fun=param','lang'=>'upload_param'),
        array('url'=>'model=upload&fun=default_thumb','lang'=>'default_thumb'),
        array('url'=>'model=upload&fun=font','lang'=>'font_set')
    );
