...
class stat_goodsControl extends SystemControl{
    private $links = array(
        array('url'=>'model=stat_goods&fun=pricerange','lang'=>'stat_goods_pricerange'),
        array('url'=>'model=stat_goods&fun=hotgoods','lang'=>'stat_hotgoods'),
        array('url'=>'model=stat_goods&fun=goods_sale','lang'=>'stat_goods_sale'),
    );
