...
class settingControl extends SystemControl{
    private $links = array(
        array('url'=>'model=setting&fun=base','lang'=>'web_set'),
        array('url'=>'model=setting&fun=dump','lang'=>'dis_dump')
    );
    ...
    public function baseOp(){
        ...
        if (chksubmit()){
            ...
            $update_array['site_address'] = $_POST['site_address'];
            $update_array['start_level'] = $_POST['start_level'];
