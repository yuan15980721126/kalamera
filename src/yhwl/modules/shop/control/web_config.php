...
class web_configControl extends SystemControl{
    ...
    public function web_editOp(){
        ...
        if (chksubmit()){
            ...
            showMessage(Language::get('nc_common_save_succ'),'index.php?model=web_config&fun=web_config');
        }
    ...
    public function web_htmlOp(){
        ...
        if(!empty($web_array) && is_array($web_array)) {
            ...
            showMessage(Language::get('nc_common_op_succ'),'index.php?model=web_config&fun=web_config');
        } else {
