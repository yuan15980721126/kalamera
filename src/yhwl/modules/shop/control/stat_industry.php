...
class stat_industryControl extends SystemControl{
    private $links = array(
        array('url'=>'model=stat_industry&fun=scale','lang'=>'stat_industryscale'),
        array('url'=>'model=stat_industry&fun=rank','lang'=>'stat_industryrank'),
        array('url'=>'model=stat_industry&fun=price','lang'=>'stat_industryprice'),
        array('url'=>'model=stat_industry&fun=general','lang'=>'stat_industrygeneral'),
    );
