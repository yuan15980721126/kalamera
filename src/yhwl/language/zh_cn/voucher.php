...
$lang['admin_voucher_unavailable']    = '需开启 优惠券、积分，正在跳转到设置页面 。。。';
...
$lang['admin_voucher_template_manage']= '优惠券';
$lang['admin_voucher_template_edit']= '编辑优惠券';
...
$lang['admin_voucher_setting_buyertimes_tip']	= '买家最多只能拥有同一个店铺尚未消费抵用的店铺优惠券最大数量';
//$lang['admin_voucher_setting_default_styleimg']	= '优惠券默认样式模板';
/**
 * 优惠券面额
 */
$lang['admin_voucher_price_error']   		= '优惠券面额应为大于0的整数';
$lang['admin_voucher_price_describe_error'] = '描述不能为空';
$lang['admin_voucher_price_describe_lengtherror'] = '优惠券描述不能为空且不能大于255个字符';
$lang['admin_voucher_price_points_error']   = '默认兑换积分数应为大于0的整数';
$lang['admin_voucher_price_exist']    		= '该优惠券面额已经存在';
$lang['admin_voucher_price_title']    		= '优惠券面额';
$lang['admin_voucher_price_describe']    	= '描述';
$lang['admin_voucher_price_points']    		= '兑换积分数';
$lang['admin_voucher_price_points_tip']    	= '当兑换优惠券时，消耗的积分数';
$lang['admin_voucher_price_tip1']    	= '管理员规定优惠券面额，店铺发放优惠券时面额从规定的面额中选择';
/**
 * 优惠券套餐申请
 */
$lang['admin_voucher_apply_goldnotenough']	= '该会员金币不够，操作失败';
$lang['admin_voucher_apply_goldlog']    	= '购买优惠券活动%s个月，单价%s金币，总共花费%s金币';
$lang['admin_voucher_apply_message']    	= '您成功购买优惠券活动%s个月，单价%s金币，总共花费%s金币，时间从审核后开始计算';
...
$lang['admin_voucher_apply_list_tip2']    	= '当商家金币不足时审核会失败，商家发布成功的优惠券会出现在积分中心，买家可凭积分进行兑换';
...
$lang['admin_voucher_template_title']			= '优惠券名称';
...
$lang['admin_voucher_template_describe']		= '优惠券描述';
$lang['admin_voucher_template_styleimg']		= '选择优惠券皮肤';
$lang['admin_voucher_template_image']			= '优惠券图片';
$lang['admin_voucher_template_points']			= '兑换所需积分数';
$lang['admin_voucher_template_adddate']			= '添加时间';
$lang['admin_voucher_template_list_tip']		= '手工设置优惠券失效后,用户将不能领取该优惠券,但是已经领取的优惠券仍然可以使用';
