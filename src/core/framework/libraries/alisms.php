...
// echo dirname(__DIR__) . '/libraries/alisms_php/api_sdk/vendor/autoload.php';
include_once dirname(__DIR__) . '/libraries/alisms_php/api_sdk/vendor/autoload.php';
...
class Alisms
{
    private $accessKeyId = "LTAIgG9U6gi5xUwR";
    private $accessKeySecret = "s5ems2EqDQWXDCwXttedWMJz0uWSIG";
    /**
     * 构造器
     *
