<link type="text/css" rel="stylesheet" href="<?php echo RESOURCE_SITE_URL."/js/jquery-ui/themes/ui-lightness/jquery.ui.css";?>"/>
  ...
  <div class="tabmenu">
	...
	<div class="ncsc-form-default">
	  <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?model=store_voucher&fun=<?php echo $output['type']=='add'?'templateadd':'templateedit'; ?>">
	  	<input type="hidden" id="act" name="model" value="store_voucher"/>
	  	<?php if ($output['type'] == 'add'){?>
	  	<input type="hidden" id="op" name="fun" value="templateadd"/>
	  	<?php }else {?>
	  	<input type="hidden" id="op" name="fun" value="templateedit"/>
