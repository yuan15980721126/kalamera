...
<div class="item-publish">
    <form enctype="multipart/form-data" method="post" id="goods_form" action="<?php if ($output['edit_goods_sign']) {
        ...
        <div class="ncsc-form-goods">
            ...
            <dl>
                ...
                <dd>
                    <textarea name="g_name"
                              class="textarea h60 w400"><?php echo $output['goods']['goods_name']; ?></textarea>
                    <span></span>
                    <p class="hint"><?php echo $lang['store_goods_index_goods_name_help']; ?></p>
                </dd>
            </dl>
            <dl>
                <dt><?php echo $lang['store_goods_index_goods_sort'] . $lang['nc_colon']; ?></dt>
                <dd>
                    <input name="g_sort" type="text" class="text w60" value="<?php echo $output['goods']['sort']; ?>"/>
                    <span></span>
                    <p class="hint"><?php echo $lang['store_goods_index_goods_sort_help']; ?></p>
                </dd>
            </dl>
            <dl>
                ...
                <dd>
                    ...
                    <span></span>
                    <p class="hint">商品卖点最长不能超过500个汉字</p>
                </dd>
            </dl>
            <dl>
            ...
            <dl>
                <dl>
                    <dt><?php echo '主要特点' . $lang['nc_colon']; ?></dt>
                    <dd id="ncProductquality">
                        <div class="tabs">
                            <div id="panel-1" class="ui-tabs-panel">
                                <?php showEditor('goods_quality', $output['goods']['goods_quality'], '100%', '300px', 'visibility:hidden;', "false", $output['editor_multimedia']); ?>
                            </div>
                    </dd>
                </dl>
                <dl>
                    <dt><?php echo '满意保证' . $lang['nc_colon']; ?></dt>
                    <dd id="ncProductguarantee">
                        <div class="tabs">
                            <div id="panel-1" class="ui-tabs-panel">
                                <?php showEditor('goods_guarantee', $output['goods']['goods_guarantee'], '100%', '300px', 'visibility:hidden;', "true", $output['editor_multimedia']); ?>
                            </div>
                    </dd>
                </dl>
                <dl>
                    <dt><?php echo '规格描述' . $lang['nc_colon']; ?></dt>
                    <dd id="ncProductgoods_spec_desc">
                        <div class="tabs">
                            <div id="panel-1" class="ui-tabs-panel">
                                <?php showEditor('goods_spec_desc', $output['goods']['goods_spec_desc'], '100%', '300px', 'visibility:hidden;', "false", $output['editor_multimedia']); ?>
                            </div>
                    </dd>
                </dl>
                <dl>
                    <dt><?php echo '提醒' . $lang['nc_colon']; ?></dt>
                    <dd id="ncProductgoods_tixing">
                        <div class="tabs">
                            <div id="panel-1" class="ui-tabs-panel">
                                <?php showEditor('goods_tixing', $output['goods']['goods_tixing'], '100%', '300px', 'visibility:hidden;', "false", $output['editor_multimedia']); ?>
                            </div>
                    </dd>
                </dl>
                <dl>
                        ...
                        <div class="ncsc-brand-select">
                            <div class="selection">
                                <input name="b_name" id="b_name" value="<?php echo $output['goods']['brand_name']; ?>"
                                       type="text" class="text w180" readonly/><input type="hidden" name="b_id"
                                                                                      id="b_id"
                                                                                      value="<?php echo $output['goods']['brand_id']; ?>"/><em
                                        class="add-on"><i class="icon-collapse"></i></em></div>
                            <div class="ncsc-brand-select-container">
                                ...
                                <div class="no-result" nctype="noBrandList" style="display: none;">没有符合"<strong>search关键字</strong>"条件的品牌
                                </div>
                                <div class="tc"><a href="javascript:void(0);" class="ncbtn-mini"
                                                   onclick="$(this).parents('.ncsc-brand-select-container:first').hide();">关闭品牌列表</a>
                                </div>
                            </div>
                    ...
                    <dd id="ncProductDetails">
                        <div class="tabs">
                            <ul class="ui-tabs-nav">
                                <li class="ui-tabs-selected"><a href="#panel-1"><i class="icon-desktop"></i> 电脑端</a>
                                </li>
                  ...
                  <input type="file" hidefocus="true" size="1" class="input-file" name="add_album" id="add_album"
                         multiple>
                                    ...
                                    <a class="ncbtn mt5" nctype="show_desc"
                                       href="index.php?model=store_album&fun=pic_list&item=des"><i
                            ...
                            <div id="panel-2" class="ui-tabs-panel ui-tabs-hide">
                                ...
                                <div class="ncsc-mobile-edit-area" nctype="mobile_editor_area">
                                    ...
                                    <div class="ncsc-mea-text" nctype="mea_txt" style="display: none;">
                                        ...
                                        <div class="button"><a class="ncbtn ncbtn-bluejeansjeansjeans"
                                                               nctype="meat_submit" href="javascript:void(0);">确认</a><a
                                                    class="ncbtn ml10" nctype="meat_cancel" href="javascript:void(0);">取消</a>
                                        </div>
          ...
          <select name="plate_bottom">
            <option>请选择</option>
              ...
              <?php } ?>
                                ...
                                <div nctype="div_freight"
                                    ...
                                    <span id="postageName" class="transport-name"
                                          <?php if ($output['goods']['transport_title'] != '' && intval($output['goods']['transport_id'])) { ?>style="display: inline-block;"<?php } ?>><?php echo $output['goods']['transport_title']; ?></span><a
                                            ...
                                            onclick="window.open('index.php?model=store_transport&type=select')"
                                            class="ncbtn" id="postageButton"><i
                ...
                <!-- 商品物流信息 E -->
                <h3 id="demo5" nctype="virtual_null"
                    <?php if ($output['goods']['is_virtual'] == 1) { ?>style="display:none;"<?php } ?>>发票信息</h3>
                <dl nctype="virtual_null"
                    <?php if ($output['goods']['is_virtual'] == 1) { ?>style="display:none;"<?php } ?>>
                    <dt>是否开增值税发票：</dt>
                    <dd>
                        <ul class="ncsc-form-radio-list">
                            <li>
                                <label>
                                    <input name="g_vat" value="1"
                                           <?php if (!empty($output['goods']) && $output['goods']['goods_vat'] == 1) { ?>checked="checked" <?php } ?>
                                           type="radio"/>
                                    <?php echo $lang['nc_yes']; ?></label>
                            </li>
                            <li>
                                <label>
                                    <input name="g_vat" value="0"
                                           <?php if (empty($output['goods']) || $output['goods']['goods_vat'] == 0) { ?>checked="checked" <?php } ?>
                                           type="radio"/>
                ...
                <dl>
                    ...
                    <dd><span class="new_add"><a href="javascript:void(0)" id="add_sgcategory"
                                                 class="ncbtn"><?php echo $lang['store_goods_index_new_class']; ?></a> </span>
        ...
        <div class="bottom tc hr32">
            <label class="submit-border">
                <input type="submit" nctype="formSubmit" class="submit" value="<?php if ($output['edit_goods_sign']) {
                    echo 'submit';
    ...
    $(function () {
        ...
        $('#goods_form').validate({
            ...
            messages: {
                ...
                g_jingle: {
                    maxlength: '<i class="icon-exclamation-sign"></i>商品卖点不能超过500个字符'
                },
                g_price: {
