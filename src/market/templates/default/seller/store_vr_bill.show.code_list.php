...
<table class="ncsc-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td>
       	<a target="_blank" href="index.php?model=store_vr_order&fun=show_order&order_id=<?php echo $code_info['order_id'];?>"><?php echo $lang['nc_view'];?></a>
        </td>
      </tr>
      <?php } ?>
      <?php } else { ?>
...
$(function(){
    $('#ncexport').click(function(){
    	$('input[name="fun"]').val('export_order');
    	$('#formSearch').submit();
    });
    $('#ncsubmit').click(function(){
    	$('input[name="fun"]').val('show_bill');
    	$('#formSearch').submit();
    });
});
</script>