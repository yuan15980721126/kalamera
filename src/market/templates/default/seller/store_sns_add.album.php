...
<div class="groupbuy-gallery" nctype="store_sns_album"> <a class="sample_demo" id="select_s" href="index.php?model=store_album&fun=pic_list&item=store_sns_normal" style="display:none;"><?php echo $lang['nc_submit'];?></a>
