...
<form id="pay_form" method="post" enctype="multipart/form-data" action="index.php?model=store_contract&fun=applypay">
	<input type="hidden" id="act" name="model" value="store_contract"/>
	<input type="hidden" id="op" name="fun" value="applypay"/>
