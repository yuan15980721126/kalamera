<div class="goods-gallery add-step2"> <a class="sample_demo" id="select_s" href="index.php?model=store_album&fun=pic_list&item=des" style="display:none;"><?php echo $lang['nc_submit'];?></a>
