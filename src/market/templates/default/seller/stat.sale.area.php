...
<div class="alert mt10">
	<ul class="mt5">
		...
		<li>2、统计图展示了符合search条件的有效订单的下单会员数、下单总金额和下单数量在各省级地区的分布情况</li>
...
<form method="get" action="index.php" target="_self">
    ...
    <input type="hidden" name="fun" value="area" />
...
<div id="stat_tabs" class="ui-tabs" style="min-height:500px;padding-top:10px;">
    ...
    <div id="membernum_div" nc_type="datacontainer" class="tc">
        ...
        <?php } else {?>
        <div class="warning-option"><i class="icon-warning-sign"></i><span>No eligible data records</span></div>
        <?php }?>
    </div>
    <!-- 下单金额 -->
