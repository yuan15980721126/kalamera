...
<div class="ncsc-form-default">
  <form id="add_form" action="index.php?model=store_groupbuy&fun=groupbuy_save&vr=1" method="post" enctype="multipart/form-data">
    <dl>
...
<?php } ?>
          ...
          <table class="search-form">
              <tr>
                  ...
                  <td class="w70 tc">
                    ...
                    <td class="w10"></td>
                    <td>
                        <p class="hint">不输入名称直接search将显示店内所有虚拟商品。</p>
                    </td>
                </tr>
            </table>
    ...
    <dl>
      ...
      <dd>
        ...
        <p class="hr8"><a class="des_demo ncbtn" href="index.php?model=store_album&fun=pic_list&item=groupbuy"><i class="icon-picture"></i><?php echo $lang['store_goods_album_insert_users_photo'];?></a></p>
...
$("select[name=class]").change(function(){
    ...
    $.ajax({
        type:'GET',
        url:'index.php?model=store_groupbuy&fun=ajax_vr_class&class_id='+class_id,
...
$("select[name=city]").change(function(){
    ...
    $.ajax({
        type:'GET',
        url:'index.php?model=store_groupbuy&fun=ajax_vr_area&area_id='+area_id,
        success:function(json){
            var html = '<option value="">'+'请选择...'+'</option>';
