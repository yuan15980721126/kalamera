...
<?php if ($output['isOwnShop']) { ?>
  <a href="<?php echo urlShop('store_groupbuy', 'groupbuy_add_vr'); ?>" style="right:100px; visibility: hidden;" class="ncbtn ncbtn-mint" title="新增虚拟商品抢购"><i class="icon-plus-sign"></i>新增虚拟抢购</a>
...
<?php } else { ?>
  ...
  <a href="<?php echo urlShop('store_groupbuy', 'groupbuy_add_vr'); ?>" style="right:200px; visibility: hidden;" class="ncbtn ncbtn-mint" title="新增虚拟商品抢购"><i class="icon-plus-sign"></i>新增虚拟抢购</a>
...
<table class="search-form">
  <form method="get">
    <input type="hidden" name="model" value="store_groupbuy" />
    <tr>
      <td>&nbsp;</td>
      <th>抢购类型</th>
      <td class="w100">
