...
<div class="tabmenu">
  <?php include template('layout/submenu');?>
    <a title="批量生成商品二维码" class="ncbtn ncbtn-aqua" href="index.php?model=store_goods_online&amp;fun=maker_qrcode" style="right:100px" onclick="return confirm('您确定要执行批量生成二维码吗？');">批量生成商品二维码</a>
...
<form method="get" action="index.php">
  <table class="search-form">
    <input type="hidden" name="model" value="store_goods_online" />
...
<table class="ncsc-default-table">
  <thead>
    <tr nc_type="table_header">
      ...
      <th class="w100"><?php echo $lang['store_goods_index_sort'];?></th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><span><?php echo $val['sort']; ?></span></td>
