...
<?php if ($output['order_info']) {?>
  ...
  <form id="changeform" method="post" action="index.php?model=store_order&fun=change_state&state_type=modify_price&order_id=<?php echo $output['order_info']['order_id']; ?>">
