        ...
        <div class="ncsc-order-details">
            ...
            <div class="content">
                <dl>
                    ...
                    <dd><?php echo str_replace('---', '  ', $output['order_info']['extend_order_common']['reciver_name']); ?>
                        ,&nbsp; <?php echo @$output['order_info']['extend_order_common']['reciver_info']['phone']; ?>,&nbsp; <?php echo @$output['new_address']; ?><?php echo $output['order_info']['extend_order_common']['reciver_info']['dlyp'] ? '[自提服务站]' : ''; ?></dd>
                </dl>
                <dl>
                    <dt>邮政编码：</dt>
                    <dd><?php echo @$output['order_info']['extend_order_common']['reciver_info']['zipcode']; ?></dd>
                </dl>
                ...
                <dl class="line">
                    ...
                    <dd><?php echo $output['order_info']['order_sn']; ?><a href="javascript:void(0);">更多<i
                                    class="icon-angle-down"></i>
                            <div class="more"><span class="arrow"></span>
                                <ul>
                                    <li>
                                        <span><?php echo date("Y-m-d H:i:s", $output['order_info']['add_time']); ?></span>买家下单
                                    </li>
                                    <?php if (is_array($output['order_log_list'])) { ?>
                                        <?php foreach ($output['order_log_list'] as $log_info) { ?>
                                            <li>
                                                <span><?php echo date('Y-m-d H:i:s', $log_info['log_time']); ?></span><?php echo $log_info['log_role']; ?> <?php echo $log_info['log_msg']; ?>
                                            </li>
                                        <?php } ?>
                                    <?php } ?>
                                </ul>
        ...
        <?php if ($output['order_info']['order_state'] == ORDER_STATE_PAY) { ?>
            <div class="ncsc-order-condition">
                ...
                <ul>
                    ...
                    <?php } else { ?>
                        <li>1. 买家已使用“<?php echo orderPaymentName($output['order_info']['payment_code']); ?>
                            ”方式成功对订单进行支付，支付单号 “<?php echo $output['order_info']['pay_sn']; ?>”。
                        </li>
                        <li>2. 订单已提交商家进行备货发货准备。</li>
                    <?php } ?>
                </ul>
            ...
            <?php if ($output['order_info']['evaluation_state'] == 1) { ?>
                <div class="ncsc-order-condition">
                    ...
                    <ul>
                        ...
                        <li>2. 可以在<a href="index.php?model=store_evaluate&fun=list" class="ncbtn-mini">评价管理</a>查看详细内容。
                        </li>
                    </ul>
                </div>
            <?php } else { ?>
        ...
        <div id="order-step" class="ncsc-order-step">
            ...
            <?php if ($output['order_info']['payment_code'] != 'offline') { ?>
                <dl class="<?php if (intval($output['order_info']['payment_time']) && $output['order_info']['order_pay_state'] !== false) echo 'current'; ?>">
                    ...
                    <dd class="bg"></dd>
                    <dd class="date"
                        title="<?php echo $lang['store_show_order_pay_time']; ?>"><?php echo intval(date("His", $output['order_info']['payment_time'])) ? date("Y-m-d H:i:s", $output['order_info']['payment_time']) : date("Y-m-d", $output['order_info']['payment_time']); ?></dd>
                </dl>
            <?php } ?>
            ...
            <dl class="<?php if ($output['order_info']['evaluation_state'] == 1) { ?>current<?php } ?>">
                ...
                <dd class="bg"></dd>
                <dd class="date"
                    title="<?php echo $lang['store_show_order_finish_time']; ?>"><?php echo date("Y-m-d H:i:s", $output['order_info']['extend_order_common']['evaluation_time']); ?></dd>
            </dl>
        </div>
    <?php } ?>
        ...
        <table class="ncsc-default-table order">
            ...
            <?php if (!empty($output['order_info']['shipping_code'])) { ?>
                <tr>
                    <th colspan="6" style="border-right: 0;">
                        <div class="order-deliver"><span>物流公司： <a target="_blank"
                                                                  href="<?php echo $output['order_info']['express_info']['e_url']; ?>"><?php echo $output['order_info']['express_info']['e_name']; ?></a></span>
                            <span><?php echo $lang['store_order_shipping_no'] . $lang['nc_colon']; ?><?php echo $output['order_info']['shipping_code']; ?></span><span><a
                                        href="javascript:void(0);" id="show_shipping">物流跟踪<i
                                            class="icon-angle-down"></i>
              <div class="more"><span class="arrow"></span>
                <ul id="shipping_ul">
                  <li>加载中...</li>
                    ...
                    <th colspan="3" style=" border-left: 0;"><?php if (!empty($output['daddress_info'])) { ?>
                            <dl class="daddress-info">
                                <dt>发&nbsp;&nbsp;货&nbsp;&nbsp;人：</dt>
                                <dd><?php echo $output['daddress_info']['seller_name']; ?><a href="javascript:void(0);">更多<i
                                                class="icon-angle-down"></i>
                                        <div class="more"><span class="arrow"></span>
                                            <ul>
                                                <li>
                                                    公&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;司：<span><?php echo $output['daddress_info']['company']; ?></span>
                                                </li>
                                                <li>
                                                    联系电话：<span><?php echo $output['daddress_info']['telphone']; ?></span>
                                                </li>
                                                <li>发货地址：<span><?php echo $output['daddress_info']['area_info']; ?>
                                                        &nbsp;<?php echo $output['daddress_info']['address']; ?></span>
                                                </li>
                                            </ul>
                                        </div>
                                    </a></dd>
            ...
            <?php foreach ($output['order_info']['goods_list'] as $k => $goods) { ?>
                ...
                <tr class="bd-line">
                    <td>&nbsp;</td>
                    <td class="w50">
                        <div class="pic-thumb"><a target="_blank" href="<?php echo $goods['goods_url']; ?>"><img
                                        src="<?php echo $goods['image_60_url']; ?>"/></a></div>
                    </td>
                    <td class="tl">
                        <dl class="goods-name">
                            <dt><a target="_blank"
                                   href="<?php echo $goods['goods_url']; ?>"><?php echo $goods['goods_name']; ?></a><a
                                        target="_blank"
                                        href="<?php echo urlShop('snapshot', 'index', array('rec_id' => $goods['rec_id'])); ?>"
                                        class="blue ml5">[交易快照]</a></dt>
                            <?php if ($goods['goods_repair']['percent'] != '' && $goods['goods_repair']['repair_price'] != '0.00') { ?>
                                <dd>Warranty Price :
                                    <?php echo $goods['goods_repair']['description']; ?>
                                    （$<?php echo $goods['goods_repair']['repair_price']; ?>）
                                </dd>
                            <?php } ?>
                            ...
                            <dd>
                                <?php if (is_array($output['refund_all']) && !empty($output['refund_all'])) { ?>
                                    退款单号：<a target="_blank"
                                            href="index.php?model=store_refund&fun=view&refund_id=<?php echo $output['refund_all']['refund_id']; ?>"><?php echo $output['refund_all']['refund_sn']; ?></a>
                                <?php }else if ($goods['extend_refund']['refund_type'] == 1) { ?>
                                退款单号：<a target="_blank"
                                        href="index.php?model=store_refund&fun=view&refund_id=<?php echo $goods['extend_refund']['refund_id']; ?>"><?php echo $goods['extend_refund']['refund_sn']; ?></a>
                            </dd>
                        <?php } else if ($goods['extend_refund']['refund_type'] == 2) { ?>
                            退货单号：<a target="_blank"
                                    href="index.php?model=store_return&fun=view&return_id=<?php echo $goods['extend_refund']['refund_id']; ?>"><?php echo $goods['extend_refund']['refund_sn']; ?></a>
                            </dd>
                        <?php } ?>
                        </dl>
                    </td>
                    ...
                    <td class="commis bdl bdr"><?php if ($goods['commis_rate'] != 200) { ?>
                            <?php echo $goods['goods_pay_price']; ?> * <?php echo $goods['commis_rate']; ?>% =
                            <b><?php echo ncPriceFormat($goods['goods_pay_price'] * $goods['commis_rate'] / 100); ?></b>
                        <?php } ?></td>

                    <!-- S 合并TD -->
                    <?php if (($output['order_info']['goods_count'] > 1 && $k == 0) || ($output['order_info']['goods_count'] == 1)) { ?>
                        <td class="bdl bdr"
                            rowspan="<?php echo $output['order_info']['goods_count']; ?>"><?php echo $output['order_info']['state_desc']; ?>
                            ...
                            <?php if ($output['order_info']['if_modify_price']) { ?>
                                <p><a href="javascript:void(0)" class="ncbtn"
                                      uri="index.php?model=store_order&fun=change_state&state_type=modify_price&order_sn=<?php echo $output['order_info']['order_sn']; ?>&order_id=<?php echo $output['order_info']['order_id']; ?>"
                                      dialog_width="480" dialog_title="<?php echo $lang['store_order_modify_price']; ?>"
                                      nc_type="dialog" dialog_id="seller_order_adjust_fee"
                                      id="order<?php echo $output['order_info']['order_id']; ?>_action_adjust_fee"/>修改运费</a>
                                </p>
                            <?php } ?>
                            ...
                            <?php if ($output['order_info']['if_cancel']) { ?>
                                <p><a href="javascript:void(0)" style="color:#F30; text-decoration:underline;"
                                      nc_type="dialog"
                                      uri="index.php?model=store_order&fun=change_state&state_type=order_cancel&order_sn=<?php echo $output['order_info']['order_sn']; ?>&order_id=<?php echo $output['order_info']['order_id']; ?>"
                                      dialog_title="<?php echo $lang['store_order_cancel_order']; ?>"
                                      dialog_id="seller_order_cancel_order" dialog_width="400"
                                      id="order<?php echo $output['order_info']['order_id']; ?>_action_cancel"/><?php echo $lang['store_order_cancel_order']; ?></a>
                                </p>
                            <?php } ?>
                            ...
                            <?php if ($output['order_info']['if_store_send']) { ?>
                                <p><a class="ncbtn"
                                      href="index.php?model=store_deliver&fun=send&order_id=<?php echo $output['order_info']['order_id']; ?>"/><i
                                            class="icon-truck"></i><?php echo $lang['store_order_send']; ?></a></p>
                            <?php } ?></td>
                    <?php } ?>
                    <!-- E 合并TD -->
                </tr>
                                    ...
                                    <?php foreach ($output['order_info']['zengpin_list'] as $zengpin_info) { ?>
                                        <li>
                                            <a title="赠品：<?php echo $zengpin_info['goods_name']; ?> * <?php echo $zengpin_info['goods_num']; ?>"
                                               target="_blank" href="<?php echo $zengpin_info['goods_url']; ?>"><img
                                                        src="<?php echo $zengpin_info['image_60_url']; ?>"/></a></li>
                                    <?php } ?>
                                </ul>
                            </div>
                        </td>
            ...
            <tr>
                <td colspan="20">
                    <dl class="freight">
                        <dd>
                            <?php if (!empty($output['order_info']['shipping_fee']) && $output['order_info']['shipping_fee'] != '0.00') { ?>
                                <?php echo $lang['store_show_order_tp_fee']; ?>:
                                <span><?php echo $lang['currency']; ?><?php echo $output['order_info']['shipping_fee']; ?></span>
                            <?php } else { ?>
                    ...
                    <?php if ($output['order_info']['tax'] > 0) { ?>
                        <dl class="freight">
                            <dd>
                                <span>税费百分比<?php echo $lang['nc_colon'] . ncPriceFormat($output['order_info']['tax']); ?>
                                    %</span>
                            </dd>
                        </dl>
                    <?php } ?>
                    <?php if ($output['order_info']['tax_payment'] > 0) { ?>
                        <dl class="freight">
                            <dd>
                                <span>(税费<?php echo $lang['nc_colon'] . '$' . ncPriceFormat($output['order_info']['tax_payment']); ?>
                                    )</span>
                            </dd>
                        </dl>
                    <?php } ?>
...
<script type="text/javascript">
    $(function () {
        $('#show_shipping').on('hover', function () {
            ...
            $.getJSON('index.php?model=seller_center&fun=get_express&e_code=<?php echo $output['order_info']['express_info']['e_code']?>&shipping_code=<?php echo $output['order_info']['shipping_code']?>&t=<?php echo random(7);?>', function (data) {
                if (data) {
                    data = var_send + data;
