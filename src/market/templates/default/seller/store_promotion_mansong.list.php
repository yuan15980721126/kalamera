...
<form method="get">
  <table class="search-form">
    <input type="hidden" name="model" value="store_promotion_mansong" />
    <input type="hidden" name="fun" value="mansong_list" />
    <tr>
      <td>&nbsp;</td>
...
<table class="ncsc-default-table">
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle"><span><a href="index.php?model=store_promotion_mansong&fun=mansong_detail&mansong_id=<?php echo $val['mansong_id'];?>" class="btn-bluejeans"><i class="icon-th-list"></i>
