...
<div class="ncsc-login-container">
  <div class="ncsc-login-title nuo-null">
    <h2>商家管理中心</h2>
    <h4><a href="<?php echo urlChain('login');?>">门店管理登录</a></h4>
    <span>请使用入驻申请时填写的“商家用户名”作为登录用户名<br/>
    登录密码则商城用户密码一致</span>
    </div>
  <form id="form_login" action="index.php?model=seller_login&fun=login" method="post" >
    ...
    <div class="input">
      ...
      <div class="code">
        <div class="arrow"></div>
        <div class="code-img"><a href="javascript:void(0)" nctype="btn_change_seccode"><img src="index.php?model=seccode&fun=makecode&nchash=<?php echo $output['nchash'];?>" name="codeimage" border="0" id="codeimage"></a></div>
  ...
  <!--<div class="copyright">Powered by <?php echo $output['setting_config']['33hao_version'];?> © 2005-2016 </div>-->
</div>
</body>
</html>
