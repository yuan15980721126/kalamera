  ...
  <div class="ncm-flow-container">
    ...
    <div id="saleRefund" show_id="1">
      ...
      <div class=" ncm-default-form">
        <div id="warning"></div>
        <form id="post_form1" enctype="multipart/form-data" method="post" action="index.php?model=member_vr_refund&fun=add_refund&order_id=<?php echo $output['order']['order_id']; ?>">
          <input type="hidden" name="form_submit" value="ok" />
          <h3>如果提交退款Save successfully，选择的对应兑换码将被锁定即不能进行兑换。</h3>
          <dl>
