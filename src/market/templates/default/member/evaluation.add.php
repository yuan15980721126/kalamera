...
<div class="ncm-flow-layout">
  <div class="ncm-flow-container">
    ...
    <form id="evalform" method="post" action="index.php?model=member_evaluate&fun=<?php echo $_GET['fun'];?>&order_id=<?php echo $_GET['order_id'];?>">
      ...
      <table class="ncm-default-table mb30">
        <tbody>
          ...
          <tr class="bd-line">
            <td class="w20"></td>
            <td class="pic-mode w200"><div class="pic-thumb"><a href="index.php?model=goods&goods_id=<?php echo $goods['goods_id']; ?>" target="_blank"><img src="<?php echo $goods['goods_image_url']; ?>"/></a></div>
              <dl class="goods-name">
                <dt><a href="index.php?model=goods&goods_id=<?php echo $goods['goods_id'];?>" target="_blank" title="<?php echo $goods['goods_name'];?>"><?php echo $goods['goods_name'];?></a></dt>
            ...
            <td valign="top" class="tl"><div class="ncgeval">商品评分：
              ...
              <textarea name="goods[<?php if ($_GET['fun'] != 'add_vr') { echo $goods['rec_id'];} else { echo $goods['goods_id'];}?>][comment]" cols="150" class="w450 mt10 mb10 h40" placeholder="请输入要评价的内容，不要超过150个字符。"></textarea>
              <div class="show-pic">
                ...
                <input type="checkbox" class="checkbox vm" name="goods[<?php if ($_GET['fun'] != 'add_vr') { echo $goods['rec_id'];} else { echo $goods['goods_id'];}?>][anony]">
      ...
      <?php if (!$output['store_info']['is_own_shop'] && $_GET['fun'] != 'add_vr') { ?>
      <div class="tabmenu">
        <ul class="tab">
