<div class="eject_con">
  ...
  <form method="post" action="index.php?model=member_vr_order&fun=change_state&state_type=order_cancel&order_id=<?php echo $output['order_info']['order_id']; ?>" id="order_cancel_form" onsubmit="ajaxpost('order_cancel_form','','','onerror')">
