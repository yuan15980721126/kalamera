...
<?php } ?>
  ...
  <div class="title">
      <?php if ($_GET['fun'] == 'index' || strpos($_GET['fun'], 'vr_groupbuy_') === 0) { ?>
      ...
      <div id="list" class="list" style="display:none;"><a id="button_close" class="close" href="javascript:void(0)">&#215;</a>
        <ul>
          <li><a href="<?php echo urlShop('show_groupbuy', 'select_city'); ?>&back_op=<?php echo $_GET['fun']; ?>&city_id=0"><?php echo $lang['text_country'];?></a></li>
          <?php $names = $output['groupbuy_vr_cities']['name']; foreach ($output['groupbuy_vr_cities']['children'][0] as $v) { ?>
          <li><a href="<?php echo urlShop('show_groupbuy', 'select_city'); ?>&back_op=<?php echo $_GET['fun']; ?>&city_id=<?php echo $v; ?>"><?php echo $names[$v]; ?></a></li>
          <?php } ?>
        </ul>
      </div>
      <?php } ?>
