...
<div id="apply_store_info" class="apply-store-info">
  <div class="alert">
    ...
    <form id="form_store_info" action="index.php?model=store_joininc&fun=step4" method="post" >
      <table border="0" cellpadding="0" cellspacing="0" class="all">
        ...
        <tr>
          <th class="w150"><i>*</i>Shop name：</th>
          <td><input name="store_name" type="text" class="w200"/>
            <span></span>
            <p class="emphasis">Shop name注册后不可修改，请认真填写。</p></td>
        </tr>
        <tr>
            <th><i>*</i>店铺等级：</th>
