...
<link rel="stylesheet" href="/skins/default/css/IntegralStore.css" />
  ...
  <div class="ncp-main-layout">
        ...
        <dd><!-- 高级searchstart -->
          <ul>
            ...
            <li>所需积分：
              ...
              <a href="javascript:searchpointprod();" class="ncbtn">search</a> </li>
            <!-- 所需积分e -->
            <li>&nbsp;</li>
            <?php if($_SESSION['is_login'] == '1'){ ?>
            <li>
    ...
    <div id="goods_list">
        <ul>
            ...
            <li>
                <div>
                  <a href="<?php echo urlShop('pointprod', 'pinfo', array('id' => $v['pgoods_id']));?>" target="_blank" > <img src="<?php echo $v['pgoods_image'] ?>" title="<?php echo $v['pgoods_name']; ?>" alt="<?php echo $v['pgoods_name']; ?>" style="width:264px;height:264px;"></a>
                </div>
                <div class="goods_">
                  <div><a href="<?php echo urlShop('pointprod', 'pinfo', array('id' => $v['pgoods_id']));?>" target="_blank"><?php echo $v['pgoods_name']; ?></a></div>
                  <div class="goods_info">
                    <div>
                      <div><?php echo $lang['pointprod_goodsprice'].$lang['nc_colon']; ?><del><?php echo $lang['currency'].ncPriceFormat($v['pgoods_price']); ?></del></div>
                      <div>积分：<span><?php echo $v['pgoods_points']; ?></span></div>
                    </div>
                    <a class="once_get" href="<?php echo urlShop('pointprod', 'pinfo', array('id' => $v['pgoods_id']));?>" target="_blank">立即兑换</a>
    ...
    <?php //<?php if (is_array($output['pointprod_list']) && count($output['pointprod_list'])){ ?> 
...
function searchpointprod(){
	var url = 'index.php?model=pointprod&fun=index';
