...
$(function(){
  ...
  <?php } else { ?>
  <li>
    <dl><dd style="text-align: center; ">No goods</dd></dl>
  </li>
<script>
$(function(){
...
<a href="javascript:void(0);" onclick="javascript:window.location.href='<?php echo SHOP_SITE_URL;?>/index.php?model=cart'">结算购物车中的商品</a>
<?php } ?>