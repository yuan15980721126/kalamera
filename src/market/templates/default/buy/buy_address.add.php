...
<form method="POST" id="address_form" action="index.php">
...
<!--    <input type="text" class="info_city" name="city" class="required info_city">-->
    ...
    <ul class="ul_three_col">
        <li>
            <input type="hidden" name="region" id="region_add"
    ...
    <div class="text-center padding-t-25 border-black-t">
        <input type="button"   id="save_address" value="Save" class="save"/>
    </div>
</form>
...
<script type="text/javascript">
    ...
    function submitAddAddr(li_id, status,cityid='',areaid='') {
        ...
        if ($('#address_form').valid()) {
            $('#buy_city_id').val($('#region_add').fetch('area_id_2'));
