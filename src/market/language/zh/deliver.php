...
$lang['store_deliver_express_note']			= '您可以通過"發貨設置-><a href="index.php?model=store_deliver&fun=express" target="_parent" >預設物流公司</a>"添加或修改常用貨運物流。免運或自提商品可切換下方<span class="red">[無需物流運輸服務]</span>選項卡並操作。';
...
$lang['store_deliver_bforget_pl']			= '請填寫备忘';
