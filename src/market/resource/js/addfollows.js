...
$(function(){
	...
	check_tuwen(1);
	var url = "index.php?model=seller_wechat&fun=showfollow";
...
function btnsave(num,count){
	...
	if(ktype==1){
		...
		var url = "index.php?model=seller_wechat&fun=addfollow";
		...
		var url = "index.php?model=seller_wechat&fun=addfollow";
		//var url = "/biz.php?ctl=wechat&model=addfollow";
				    ...
				    success: function (data, status)
				    {
						...
						$(obj).parent().find(".fileuploading").addClass("hide");
				   		if(data.status==1)
				   		{
							...
							//var img_url = 'http://localhost:550'+data.big_url;
							//var mid_url = 'http://localhost:550'+data.mid_url;
						    if(0==zsc_count){ //大图
