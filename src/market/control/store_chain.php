...
class store_chainControl extends BaseSellerControl {
    ...
    public function __construct() {
        ...
        if (!checkPlatformStore()) {
            showMessage('This function is only used by the platform\'s own stores', urlShop('seller_center', 'index'), '', 'error');//该功能只有平台自营店铺使用
        }
    ...
    public function chain_addOp() {
        ...
        if (chksubmit()){
            ...
            if ($result) {
                showDialog('Operation is successful', urlShop('store_chain', 'index'), 'succ');
            } else {
                showDialog('The operation failure', 'reload');
            }
        }
    ...
    public function chain_delOp() {
        ...
        if ($result) {
            showDialog('Delete the success', urlShop('store_chain', 'index'), 'succ');
        } else {
            showDialog('Delete failed', 'reload');
        }
    }
