...
class store_complainControl extends BaseSellerControl{
    ...
    public function appeal_saveOp() {
        ...
        showDialog(Language::get('appeal_submit_success'),'index.php?model=store_complain','succ');
    }
    ...
    public function apply_handleOp() {
        ...
        showMessage(Language::get('handle_submit_success'),'index.php?model=store_complain');
    }
    ...
    private function profile_menu($menu_key='') {
        $menu_array = array(
            array('menu_key'=>'complain_accused_list','menu_name'=>Language::get('complain_manage_title'),'menu_url'=>'index.php?model=store_complain')
        );
