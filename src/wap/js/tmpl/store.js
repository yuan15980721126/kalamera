...
$(function() {
    ...
    $.ajax({
        type: 'post',
        url: ApiUrl + "/index.php?model=store&fun=store_info",
    ...
    $('#goods_rank_tab').find('a').click(function(){
        ...
        $.ajax({
            type: 'post',
            url: ApiUrl + '/index.php?model=store&fun=store_goods_rank',
    ...
    function getStoreNewGoods(){
        ...
        load_class_newgoods.loadInit({'url':ApiUrl + '/index.php?model=store&fun=store_new_goods','getparam':param,'tmplid':'newgoods_tpl','containerobj':$("#newgoods"),'iIntervalId':true,'resulthandle':'tidyStoreNewGoodsData'});
    }
    //加载店铺促销活动
    function getStoreActivity(){
        $.ajax({
            type: 'post',
            url: ApiUrl + "/index.php?model=store&fun=store_promotion",
