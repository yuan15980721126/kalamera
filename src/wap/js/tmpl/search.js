$(function(){
    ...
    $('#keyword').on('input',function(){
    	...
    	if (value == '') {
            ...
            $.getJSON(ApiUrl + '/index.php?model=goods&fun=auto_complete',{term:$('#keyword').val()}, function(result) {
    ...
    $.getJSON(ApiUrl + '/index.php?model=index&fun=search_key_list', function(result) {
    	var data = result.datas;
    	data.WapSiteUrl = WapSiteUrl;
