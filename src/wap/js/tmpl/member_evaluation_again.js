$(function(){
    ...
    $.getJSON(ApiUrl + '/index.php?model=member_evaluate&fun=again', {key:key, order_id:order_id}, function(result){
        ...
        $('input[name="file"]').ajaxUploadImage({
            url : ApiUrl + "/index.php?model=sns_album&fun=file_upload",
            data:{key:key},
        ...
        $('.btn-l').click(function(){
            ...
            $.ajax({//获取区域列表
                type:'post',
                url:ApiUrl+'/index.php?model=member_evaluate&fun=save_again',
                data:param,
                dataType:'json',
                async:false,
