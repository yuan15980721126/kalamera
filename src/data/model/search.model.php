     ...
     public function getLeftCategory($param, $sign = 0) {
        ...
        foreach ($data as $value) {
            ...
            if (!empty($gc_list[$value[0]])){   // 一级
                ...
                $tpl_data[$value[0]]['gc_parent_id'] = $gc_list[$value[0]]['gc_parent_id'];
                if (!empty($gc_list[$value[0]]['class2'][$value[1]])) { // 二级
                    ...
                    $tpl_data[$value[0]]['class2'][$value[1]]['gc_parent_id'] = $gc_list[$value[0]]['class2'][$value[1]]['gc_parent_id'];
                    if (!empty($gc_list[$value[0]]['class2'][$value[1]]['class3'][$value[2]])) {    // 三级
                        ...
                        $tpl_data[$value[0]]['class2'][$value[1]]['class3'][$value[2]]['gc_parent_id'] = $gc_list[$value[0]]['class2'][$value[1]]['class3'][$value[2]]['gc_parent_id'];
                        if (!$sign) {   // 取得全部三级分类
                            foreach ($gc_list[$value[0]]['class2'][$value[1]]['class3'] as $val) {
                                ...
                                $tpl_data[$value[0]]['class2'][$value[1]]['class3'][$val['gc_id']]['gc_parent_id'] = $val['gc_parent_id'];
                        ...
                        if (!$sign) {   // 取得同级分类
                            if (!empty($gc_list[$value[0]]['class2'])) {
                                foreach ($gc_list[$value[0]]['class2'] as $gc2) {
                                    ...
                                    $tpl_data[$value[0]]['class2'][$gc2['gc_id']]['gc_parent_id'] = $gc2['gc_parent_id'];
                                    if (!empty($gc2['class3'])) {
                                        foreach ($gc2['class3'] as $gc3) {
                                            ...
                                            $tpl_data[$value[0]]['class2'][$gc2['gc_id']]['class3'][$gc3['gc_id']]['gc_parent_id'] = $gc3['gc_parent_id'];
                                        }
                                    }
                                }
                            }
                            ...
                            foreach ($gc_list as $gc1) {
                                ...
                                if (!empty($gc1['class2'])) {
                                    foreach ($gc1['class2'] as $gc2) {
                                        ...
                                        $tpl_data[$gc1['gc_id']]['class2'][$gc2['gc_id']]['gc_parent_id'] = $gc2['gc_parent_id'];
                                        if (!empty($gc2['class3'])) {
                                            foreach ($gc2['class3'] as $gc3) {
                                                ...
                                                $tpl_data[$gc1['gc_id']]['class2'][$gc2['gc_id']]['class3'][$gc3['gc_id']]['gc_parent_id'] = $gc3['gc_parent_id'];
                                            }
                                        }
                                    }
                                }
