...
//        print_r($voucher_list);
    ...
    public function getMemberVoucherList($member_id, $voucher_state, $page = null, $order = 'voucher_id desc') {
        ...
        $field = 'voucher_id,voucher_code,voucher.voucher_t_id,voucher_title,voucher_desc,voucher_start_date,voucher_end_date,voucher_price,voucher_limit,voucher_state,voucher_order_id,voucher_store_id,store_name,store_id,store_domain,store_label,store_avatar,is_own_shop,voucher_t_customimg';
