...
$_GET['model'] = is_string($_GET['model']) ? strtolower($_GET['model']) : (is_string($_POST['model']) ? strtolower($_POST['model']) : null);
...
//统一ACTION
$_GET['model'] = preg_match('/^[\w]+$/i',$_GET['model']) ? $_GET['model'] : 'index';
