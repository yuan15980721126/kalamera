...
//			左
 	$("#move_img").width($("#move_img>li").width()*$("#move_img>li").length);
			var steps=0;
		$("#point_r").on("click",function(){

			if(steps>$("#move_img li").length-7){
				return false;
			}
				steps++;
			$("#move_img").animate({left:-($("#move_img li").width()*steps)},700)

		})
		
//		右
$("#point_l").on("click",function(){
...
//		一楼切换功能
	...
	$(".three_floor .flag_n>li").on("click",function(){
		...
		$("#nav1").hover(function(){
			$(this).find("img").prop("src","/skins/default/img/success/9.png");
			
			
		},function(){
			$(this).find("img").prop("src","/skins/default/img/success/1.png");
			
		});
		
		$("#nav2").hover(function(){
			$(this).find("img").prop("src","/skins/default/img/success/10.png");
			
			
		},function(){
			$(this).find("img").prop("src","/skins/default/img/success/2.png");
			
		});
		
		
		$("#nav3").hover(function(){
			$(this).find("img").prop("src","/skins/default/img/success/11.png");
			
			
		},function(){
			$(this).find("img").prop("src","/skins/default/img/success/3.png");
			
		});
		
		
		$("#nav4").hover(function(){
			$(this).find("img").prop("src","/skins/default/img/success/12.png");
			
			
		},function(){
			$(this).find("img").prop("src","/skins/default/img/success/4.png");
			
		});
		$("#nav5").hover(function(){
			$(this).find("img").prop("src","/skins/default/img/success/13.png");
			
			
		},function(){
			$(this).find("img").prop("src","/skins/default/img/success/5.png");
			
		});
		$("#nav6").hover(function(){
			$(this).find("img").prop("src","/skins/default/img/success/14.png");
			
			
		},function(){
			$(this).find("img").prop("src","/skins/default/img/success/6.png");
			
		});
		$("#nav7").hover(function(){
			$(this).find("img").prop("src","/skins/default/img/success/15.png");
			
			
		},function(){
			$(this).find("img").prop("src","/skins/default/img/success/7.png");
			
		});
		$("#nav8").hover(function(){
			$(this).find("img").prop("src","/skins/default/img/success/16.png");
			
			
		},function(){
			$(this).find("img").prop("src","/skins/default/img/success/8.png");
