...
//	}
	...
	$compile .= "\nBase::run();";
	file_put_contents(RUNCOREPATH,compress_code("<?php defined('interMarket') or exit('Access Invalid-core!');".$compile));
}
...
function compile($filename) {
    ...
    $content = str_ireplace("defined('interMarket') or exit('Access Invalid-core!')", '', $content);
