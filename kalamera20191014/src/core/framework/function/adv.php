...
function advlist($ap_id){
    ...
    foreach ($list as $key => $value) {
        $pic_content = unserialize($value['adv_content']);
        $arr[$key]['pic'] = $pic_content['adv_pic'];
        $arr[$key]['pic2'] = $pic_content['adv_pic2'];
        $arr[$key]['url'] = $pic_content['adv_pic_url'];
        $arr[$key]['title'] = $value['adv_title'];
        $arr[$key]['word'] = $pic_content['adv_word'];
        $arr[$key]['adv_word_url'] = $pic_content['adv_word_url'];
    }
    return $arr;
}
