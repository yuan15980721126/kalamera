...
class UploadFile{
	 ...
	 * 允许上传的文件类型
	 */
	private $allow_type=array('gif','jpg','jpeg','bmp','png','swf','tbi','pdf','doc','docx','xls');
	/**
	 * 允许的最大文件大小，单位为KB
	 */
	private $max_size = '20480';
	/**
	 * 改变后的图片宽度
	 */
	 ...
	 * @return bool
	 */
	public function upfile($field,$oss = false,$check_img = false){
        ...
        if($check_img && (!$image_info = @getimagesize($this->upload_file['tmp_name']))) {
