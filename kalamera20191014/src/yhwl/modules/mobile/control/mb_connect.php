...
class mb_connectControl extends SystemControl{
    private $links = array(
        array('url'=>'model=mb_connect&fun=wx','text'=>'微信登录'),
        array('url'=>'model=mb_connect&fun=wap_wx','text'=>'WAP微信登录'),
        array('url'=>'model=mb_connect&fun=qq','text'=>'QQ互联'),
        array('url'=>'model=mb_connect&fun=sina','text'=>'新浪微博')
    );
