...
Tpl::showpage('cms_article_class.add');
    ...
    public function cms_article_class_saveOp() {
        ...
        if($result) {
            ...
            showMessage(Language::get('class_add_success'),'index.php?model=cms_article_class&fun=cms_article_class_list');
        } else {
            $this->log(Language::get('cms_log_article_class_save').$result, 0);
            showMessage(Language::get('class_add_fail'),'index.php?model=cms_article_class&fun=cms_article_class_list','','error');
        }
    ...
    private function show_menu($menu_key) {
        $menu_array = array(
            'list'=>array('menu_type'=>'link','menu_name'=>Language::get('nc_list'),'menu_url'=>'index.php?model=cms_article_class&fun=cms_article_class_list'),
            'add'=>array('menu_type'=>'link','menu_name'=>Language::get('nc_new'),'menu_url'=>'index.php?model=cms_article_class&fun=cms_article_class_add'),
        );
