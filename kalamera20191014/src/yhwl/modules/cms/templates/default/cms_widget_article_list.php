...
<div class="article-select-box">
    ...
    <ul id="article_search_list" class="article-search-list">
        ...
        <span class="title">
            ...
            <a nctype="article_item" href="<?php echo getCMSArticleUrl($value['article_id']);?>" target="_blank" class_name="<?php echo $value['class_name'];?>" article_abstrmodel="<?php echo $value['article_abstract'];?>" article_click="<?php echo $value['article_click'];?>" article_publish_time="<?php echo date('Y-m-d',$value['article_publish_time']);?>" article_image="<?php echo getCMSArticleImageUrl($value['article_attachment_path'], $value['article_image']);?>">
