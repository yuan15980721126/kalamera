...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?model=goods" title="返回商品列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3>快速添加评论 - 原创插件</a></h3>
   ...
   <input type="hidden" value="<?php echo $output["goods_list"]["goods_image"];?>" name="goodsimage">
	...
	<dl class="row">
	  ...
	  <dl class="row">
        ...
        <dd class="opt">
           <input type="text" name="add_time" id="add_time" class="input-txt" style="width:100px;" value="<?php echo @date('Y-m-d',time()); ?>"/>
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
