...
$(function(){
    $("#flexigrid").flexigrid({
    	url: 'index.php?model=article&fun=get_xml',
    	colModel : [
            ...
            {display: '备注', name : 'article_desc', width: 160, sortable : true, align : 'center'}  		
    		],
        buttons : [
...
function fg_operate(name, bDiv) {
    if (name == 'del') {
    	...
    	window.location.href = 'index.php?model=article&fun=article_add';
    }
}
...
function fg_delete(id) {
	...
	$.ajax({
        type: "GET",
        dataType: "json",
        url: "index.php?model=article&fun=delete",
        data: "del_id="+id,
