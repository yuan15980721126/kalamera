...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?model=article&fun=article" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
  ...
  <form id="article_form" method="post">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        <dt class="tit"><?php echo $lang['article_desc'];?></dt>
        <dd class="opt">
          <input type="text" value="<?php echo $output['article_array']['article_desc'];?>" name="article_desc" id="article_desc" class="input-txt">
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
...
$(document).ready(function(){
    ...
    $('#fileupload').each(function(){
        $(this).fileupload({
            dataType: 'json',
            url: 'index.php?model=article&fun=article_pic_upload&item_id=<?php echo $output['article_array']['article_id'];?>',
...
function del_file_upload(file_id)
{
    ...
    $.getJSON('index.php?model=article&fun=ajax&branch=del_file_upload&file_id=' + file_id, function(result){
        if(result){
            $('#' + file_id).remove();
        }else{
