...
Tpl::showpage('microshop_personal.manage');
    ...
    public function personal_manage_xmlOp()
    {
        ...
        foreach ($list as $val) {
            $o = '<a class="btn red confirm-del-on-click" href="index.php?model=personal&fun=personal_drop&personal_id=' .
                $val['personal_id'] .
            ...
            $u = MICROSHOP_SITE_URL.DS.'index.php?model=personal&fun=detail&personal_id=' . $val['personal_id'];
...
EOB;
            ...
            $i['member_name'] = '<a href="' .
                MICROSHOP_SITE_URL.DS.'index.php?model=home&member_id=' . $val['commend_member_id'] .
                '" target="_blank">' .
                $val['member_name'] .
                '</a>';
