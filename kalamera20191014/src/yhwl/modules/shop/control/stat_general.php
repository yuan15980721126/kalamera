...
class stat_generalControl extends SystemControl{
    private $links = array(
        array('url'=>'model=stat_general&fun=general','lang'=>'stat_generalindex'),
        array('url'=>'model=stat_general&fun=setting','lang'=>'stat_goodspricerange'),
        array('url'=>'model=stat_general&fun=orderprange','lang'=>'stat_orderpricerange')
    );
