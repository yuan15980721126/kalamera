...
class store_classControl extends SystemControl{
        ...
        if (chksubmit()){
            ...
            if ($error != ''){
                ...
                if ($result){
                    $url = array(
                    array(
                    'url'=>'index.php?model=store_class&fun=store_class_add',
                    'msg'=>$lang['continue_add_store_class'],
                    ),
                    array(
                    'url'=>'index.php?model=store_class&fun=store_class',
        ...
        if (chksubmit()){
            ...
            if ($error != ''){
                ...
                if ($result){
                    ...
                    showMessage($lang['nc_common_save_succ'],'index.php?model=store_class&fun=store_class');
                }else {
                    showMessage($lang['nc_common_save_fail']);
                }
            }
    ...
    public function store_class_delOp(){
        ...
        showMessage($lang['nc_common_del_fail'],'index.php?model=store_class&fun=store_class');
    }
