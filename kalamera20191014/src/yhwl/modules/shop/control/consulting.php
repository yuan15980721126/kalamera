...
class consultingControl extends SystemControl{
    private $links = array(
            array('url'=>'model=consulting&fun=consulting','text'=>'咨询管理'),
            array('url'=>'model=consulting&fun=type_list','text'=>'类型设置'),
            array('url'=>'model=consulting&fun=setting','text'=>'头部文字设置')
    );
    public function __construct(){
        parent::__construct();
        Language::read('consulting');
        if ($_GET['fun'] == 'index') $_GET['fun'] = 'consulting';
