...
class messageControl extends SystemControl{
    private $links = array(
        array('url'=>'model=message&fun=seller_tpl', 'lang'=>'seller_tpl'),
        array('url'=>'model=message&fun=member_tpl', 'lang'=>'member_tpl'),
    );
    ...
    public function seller_tpl_editOp() {
        ...
        $this->links[] = array('url'=>'model=message&fun=seller_tpl_edit','lang'=>'seller_tpl_edit');
    ...
    public function member_tplOp() {
        ...
        unset($mmtpl_list[3],$mmtpl_list[6],$mmtpl_list[7],$mmtpl_list[9],$mmtpl_list[12]);
    ...
    public function member_tpl_editOp() {
        ...
        $this->links[] = array('url'=>'model=message&fun=member_tpl_edit','lang'=>'member_tpl_edit');
