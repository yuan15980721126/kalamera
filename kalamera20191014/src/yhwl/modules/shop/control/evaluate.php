...
class evaluateControl extends SystemControl{
    private $links = array(
            array('url'=>'model=evaluate&fun=evalgoods_list','text'=>'来自买家的评价'),
            // array('url'=>'model=evaluate&fun=evalstore_list','text'=>'店铺动态评价')
    );
    public function __construct() {
        parent::__construct();
        Language::read('evaluate');
        if ($_GET['fun'] == 'index') $_GET['fun'] = 'evalgoods_list';
