...
<script>
$(function(){
    var flexUrl = 'index.php?model=activity&fun=activity_xml';
        ...
        buttons: [
            {
                ...
                title: '平台发起新活动',
                onpress: function() {
                    location.href = 'index.php?model=activity&fun=new';
                }
            },
            {
                ...
                onpress: function() {
                    ...
                    var href = 'index.php?model=activity&fun=del&activity_id=__IDS__'.replace('__IDS__', ids.join(','));
...
$("span[data-live-inline-edit='activity_sort']").live('click', function() {
    ...
    $input.change(function() {
        ...
        $.get('index.php?model=activity&fun=ajax&branch=activity_sort', {
...
$("span[data-live-inline-edit='activity_title']").live('click', function() {
    ...
    $input.change(function() {
        ...
        $.get('index.php?model=activity&fun=ajax&branch=activity_title', {
            id: $this.parents('tr').attr('data-id'),
