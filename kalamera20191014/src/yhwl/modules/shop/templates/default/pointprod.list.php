  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        ...
        <li><a href="index.php?model=pointprod&fun=pointorder_list" ><?php echo $lang['admin_pointorder_list_title'];?></a></li>
      </ul>
    </div>
  </div>
  <!-- 操作说明 -->
...
<script>
$(function(){
    var flexUrl = 'index.php?model=pointprod&fun=pointprod_xml';
        ...
        buttons: [
            {
                ...
                title: '新增积分兑换礼品',
                onpress: function() {
                    location.href = 'index.php?model=pointprod&fun=prod_add';
                }
            },
            {
