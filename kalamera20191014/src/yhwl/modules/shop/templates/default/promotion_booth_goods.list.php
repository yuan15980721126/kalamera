...
<?php if ($output['store_info']) { ?>
      <a class="back" href="index.php?model=promotion_booth&fun=booth_quota_list" title="返回套餐列表">
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?model=promotion_booth&fun=goods_list_xml&store_id=<?php echo $output['store_id']; ?>',
        colModel: [
