  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        <li><a href="index.php?model=member_exp&fun=index" >经验值明细</a></li>
        <li><a href="index.php?model=member_exp&fun=expsetting">规则设置</a></li>
    ...
    <div class="ncap-form-default" id="mg_tbody">
      ...
      <dl class="row" id="row_3">
        ...
        <dl class="row" id="row_4">
            ...
            <dd class="opt">
                晋级需 <input type="text" name="mg[4][exppoints]" value="<?php echo $output['list_setting']['member_grade'][4]['exppoints'];?>" class="w60" nc_type="verify" data-param='{"name":"经验值","type":"exppoints"}'/>经验值
                &nbsp;&nbsp;&nbsp;&nbsp;下单折扣 <input type="text" name="mg[4][orderdiscount]" value="<?php echo $output['list_setting']['member_grade'][4]['orderdiscount'];?>" class="w60" nc_type="verify" data-param='{"name":"下单折扣","type":"orderdiscount"}'/> %
            </dd>
        </dl>
