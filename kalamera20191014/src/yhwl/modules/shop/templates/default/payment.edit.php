...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?model=payment" title="返回支付方式列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
    ...
    <div class="ncap-form-default">
      ...
      <?php } ?>
        <?php if ($output['payment']['payment_code'] == 'paypal') { ?>
            <dl class="row">
                <dt class="tit">
                    <label><em>*</em>PayPal API用户名</label>
                </dt>
                <dd class="opt">
                    <input type="hidden" name="config_name" value="paypal_name,paypal_key,paypal_sign,ClientID,ClientSecret" />
                    <input name="paypal_name" id="paypal_name" value="<?php echo $output['config_array']['paypal_name'];?>" class="input-txt" type="text">
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            <dl class="row">
                <dt class="tit">
                    <label><em>*</em>PayPal API密码</label>
                </dt>
                <dd class="opt">
                    <input name="paypal_key" id="paypal_key" value="<?php echo $output['config_array']['paypal_key'];?>" class="input-txt" type="text">
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            <dl class="row">
                <dt class="tit">
                    <label><em>*</em>PayPal 签名</label>
                </dt>
                <dd class="opt">
                    <input name="paypal_sign" size="60" id="paypal_sign" value="<?php echo $output['config_array']['paypal_sign'];?>" class="input-txt" type="text">
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            ...
            <dl class="row">
                <dt class="tit">
                    <label><em>*</em>PayPal ClientID</label>
                </dt>
                <dd class="opt">
                    <input name="ClientID" size="60" id="ClientID" value="<?php echo $output['config_array']['ClientID'];?>" class="input-txt" type="text">
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            <dl class="row">
                <dt class="tit">
                    <label><em>*</em>PayPal ClientSecret</label>
                </dt>
                <dd class="opt">
                    <input name="ClientSecret" size="60" id="ClientSecret" value="<?php echo $output['config_array']['ClientSecret'];?>" class="input-txt" type="text">
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
        ...
        <?php if ($output['payment']['payment_code'] == 'amazonpay') { ?>
            <dl class="row">
                <dt class="tit">
                    <label><em>*</em>merchant_id</label>
                </dt>
                <dd class="opt">
                    <input type="hidden" name="config_name" value="merchant_id,access_key,secret_key,client_id,client_secret,region,currency_code,sandbox" />
                    <input name="merchant_id" id="merchant_id" value="<?php echo $output['config_array']['merchant_id'];?>" class="input-txt" type="text">
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            <dl class="row">
                <dt class="tit">
                    <label><em>*</em>access_key</label>
                </dt>
                <dd class="opt">
                    <input name="access_key" id="access_key" value="<?php echo $output['config_array']['access_key'];?>" class="input-txt" type="text">
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            <dl class="row">
                <dt class="tit">
                    <label><em>*</em>secret_key</label>
                </dt>
                <dd class="opt">
                    <input name="secret_key" size="60" id="secret_key" value="<?php echo $output['config_array']['secret_key'];?>" class="input-txt" type="text">
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            <dl class="row">
                <dt class="tit">
                    <label><em>*</em>client_id</label>
                </dt>
                <dd class="opt">
                    <input name="client_id" size="60" id="client_id" value="<?php echo $output['config_array']['client_id'];?>" class="input-txt" type="text">
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            <dl class="row">
                <dt class="tit">
                    <label><em>*</em>client_secret</label>
                </dt>
                <dd class="opt">
                    <input name="client_secret" size="60" id="client_secret" value="<?php echo $output['config_array']['client_secret'];?>" class="input-txt" type="text">
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            ...
            <dl class="row">
                <dt class="tit">
                    <label><em>*</em>region</label>
                </dt>
                <dd class="opt">
                    <select name="region" >
                        <option value="us" <?php if($output['config_array']['region'] == 'us'){ ?>selected<?php } ?>>us</option>
                        <option value="de" <?php if($output['config_array']['region'] == 'de'){ ?>selected<?php } ?>>de</option>
                        <option value="uk" <?php if($output['config_array']['region'] == 'uk'){ ?>selected<?php } ?>>uk</option>
                        <option value="jp" <?php if($output['config_array']['region'] == 'jp'){ ?>selected<?php } ?>>jp</option>
                    </select>
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            ...
            <dl class="row">
                <dt class="tit">
                    <label><em>*</em>currency_code</label>
                </dt>
                <dd class="opt">
                    <select name="currency_code" >
                        <option value="USD" <?php if($output['config_array']['currency_code'] == 'USD'){ ?>selected<?php } ?>>USD</option>
                        <option value="EUR" <?php if($output['config_array']['currency_code'] == 'EUR'){ ?>selected<?php } ?>>EUR</option>
                        <option value="GBP" <?php if($output['config_array']['currency_code'] == 'GBP'){ ?>selected<?php } ?>>GBP</option>
                        <option value="JPY" <?php if($output['config_array']['currency_code'] == 'JPY'){ ?>selected<?php } ?>>JPY</option>
                    </select>
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            ...
            <dl class="row">
                <dt class="tit">
                    <label><em>*</em>sandbox</label>
                </dt>
                <dd class="opt">

                    <div class="onoff">
                        <label for="sandbox1" class="cb-enable <?php if($output['config_array']['sandbox'] == '1'){ ?>selected<?php } ?>" ><?php echo $lang['nc_yes'];?></label>
                        <label for="sandbox2" class="cb-disable <?php if($output['config_array']['sandbox'] == '0'){ ?>selected<?php } ?>" ><?php echo $lang['nc_no'];?></label>
                        <input type="radio" <?php if($output['config_array']['sandbox'] == '1'){ ?>checked="checked"<?php }?> value="1" name="sandbox" id="sandbox1">
                        <input type="radio" <?php if($output['config_array']['sandbox'] == '0'){ ?>checked="checked"<?php }?> value="0" name="sandbox" id="sandbox2">
                        <span class="err"></span>
                        <p class="notic"></p>
                    </div>
                </dd>
