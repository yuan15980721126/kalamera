    ...
    <div class="ncap-order-details">
      ...
      <div class="tabs-panels">
        ...
        <div class="goods-info">
          ...
          <table>
            ...
            <tbody>
              ...
              <?php $i++;?>
              <tr>
                <td class="w30"><div class="goods-thumb"><a href="<?php echo SHOP_SITE_URL;?>/index.php?model=goods&goods_id=<?php echo $goods['goods_id'];?>" target="_blank"><img alt="<?php echo $lang['product_pic'];?>" src="<?php echo thumb($goods, 60);?>" /> </a></div></td>
                <td style="text-align: left;">
                    <a href="<?php echo SHOP_SITE_URL;?>/index.php?model=goods&goods_id=<?php echo $goods['goods_id'];?>" target="_blank">
                        <?php echo $goods['goods_name'];?>
                    </a>
                    <span class="rec">
                        <a target="_blank" href="<?php echo urlShop('snapshot', 'index', array('rec_id' => $goods['rec_id']));?>">
                            [交易快照]
                        </a>
                    </span>
                    <br/>
                    <?php echo $goods['goods_spec'];?>
                    <br/>
                ...
                <td class="w80"><?php echo '$'.ncPriceFormat($goods['goods_price']);?></td>
        ...
        <div class="total-amount">
          <h3><?php echo $lang['order_total_price'];?><?php echo $lang['nc_colon'];?><strong class="red_common"><?php echo '$'.ncPriceFormat($output['order_info']['order_amount']);?></strong></h3>
          <h4>(<?php echo $lang['order_total_transport'];?><?php echo $lang['nc_colon'];?><?php echo '$'.ncPriceFormat($output['order_info']['shipping_fee']);?>)</h4>
          ...
          <?php } ?>
            ...
            <h4>(税费百分比<?php echo $lang['nc_colon'].ncPriceFormat($output['order_info']['tax']);?>%)</h4>
            <?php } ?>
            <?php if($output['order_info']['tax_payment'] > 0) { ?>
                <h4>(税费<?php echo $lang['nc_colon'].'$'.ncPriceFormat($output['order_info']['tax_payment']);?>)</h4>
            <?php } ?>
        </div>
      </div>
      <?php if(is_array($output['refund_list']) and !empty($output['refund_list'])) { ?>
