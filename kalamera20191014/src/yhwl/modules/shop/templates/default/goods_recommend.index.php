...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?model=goods_recommend&fun=get_xml',
        colModel : [
...
function fg_operate(name, bDiv) {
    if (name == 'del') {
    	...
    	window.location.href = 'index.php?model=goods_recommend&fun=add';
    }
}
...
function fg_delete(id) {
	...
	$.ajax({
        type: "GET",
        dataType: "json",
        url: "index.php?model=goods_recommend&fun=delete",
        data: "del_id="+id,
