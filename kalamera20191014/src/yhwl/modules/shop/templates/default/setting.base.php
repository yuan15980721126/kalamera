  ...
  <form method="post" enctype="multipart/form-data" name="form1">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dl class="row">
            <dt class="tit">
                <label for="start_level"><?php echo $lang['start_level'];?></label>
            </dt>
            <dd class="opt">
                <textarea name="start_level" rows="6" class="tarea" id="start_level"><?php echo $output['list_setting']['start_level'];?></textarea>
                <span class="err"></span>
                <p class="notic">商品星级换算公式</p>
            </dd>
        </dl>
