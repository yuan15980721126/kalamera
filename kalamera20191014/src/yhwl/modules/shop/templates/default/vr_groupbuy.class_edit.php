...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <a class="back" href="index.php?model=vr_groupbuy&fun=class_list" title="返回列表">
  ...
  <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?model=vr_groupbuy&fun=class_edit">
