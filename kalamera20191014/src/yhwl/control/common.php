...
//         print_r($statistics);
    ...
    private function get_pending_matters() {
        ...
        $statistics['store_joinin'] = Model('store_joinin')->getStoreJoininCount(array('joinin_state' => array('in', array(10))));
        //店铺续签申请
...
//        $statistics['store_expired'] = $model_store->getStoreCount(array('store_state'=>1, 'store_end_time'=>array('between', array(1, TIMESTAMP))));
        ...
        // 报修
        $statistics['repaid'] = $model_repaid->getStoreJoininCount(array('state' => 1));
