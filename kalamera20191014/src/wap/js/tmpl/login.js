$(function(){
    ...
    $.getJSON(ApiUrl + '/index.php?model=connect&fun=get_state', function(result){
	...
	$('#loginbtn').click(function(){//会员登陆
		...
		if($.sValid()){
	          $.ajax({
				type:'post',
				url:ApiUrl+"/index.php?model=login",	
	...
	$('.weibo').click(function(){
	    location.href = ApiUrl+'/index.php?model=connect&fun=get_sina_oauth2';
	})
    $('.qq').click(function(){
        location.href = ApiUrl+'/index.php?model=connect&fun=get_qq_oauth2';
    })
    $('.weixin').click(function(){
        location.href = ApiUrl+'/index.php?model=connect&fun=index';
    })
});