$(function() {
    ...
    $.ajax({
        type:'get',
        url:ApiUrl+"/index.php?model=member_account&fun=modify_password_step4",
        data:{key:key},
        dataType:'json',
    ...
    $('#nextform').click(function(){
        ...
        if($.sValid()){
            ...
            $.ajax({
                type:'post',
                url:ApiUrl+"/index.php?model=member_account&fun=modify_password_step5",
                ...
                success:function(result){
                    if(result.code == 200){
                        $.sDialog({
                            skin:"block",
                            content:'Passwd updated successfully',
                            okBtn:false,
                            cancelBtn:false
                        });
