$(function (){
    ...
    if(!key){
        ...
        function initCartList(){
             $.ajax({
                url:ApiUrl+"/index.php?model=member_cart&fun=cart_list",
                type:"post",
                dataType:"json",
                data:{key:key},
        ...
        function delCartList(cart_id){
            $.ajax({
                url:ApiUrl+"/index.php?model=member_cart&fun=cart_del",
                type:"post",
        ...
        function editQuantity(self,type){
            ...
            $.ajax({
                url:ApiUrl+"/index.php?model=member_cart&fun=cart_edit_quantity",
                type:"post",
    ...
    $('#cart-list-wp').on('click', '.all_checkbox', function(){
    	if($(".check-out").hasClass("ok")){
		$(this).find("a").addClass("en_ok");
	};
...
function getGoods(goods_id, goods_num){
    ...
    $.ajax({
        type:'get',
        url:ApiUrl+'/index.php?model=goods&fun=goods_detail&goods_id='+goods_id,
        dataType:'json',
        async:false,
        success:function(result){
            if (result.datas.error) {
