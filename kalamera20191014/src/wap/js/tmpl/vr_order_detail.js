...
$(function(){
    ...
    $.getJSON(ApiUrl + '/index.php?model=member_vr_order&fun=order_info',{key:key,order_id:order_id}, function(result) {
        ...
        $.getJSON(ApiUrl + '/index.php?model=goods&fun=store_o2o_addr', {store_id:result.datas.order_info.store_id},function(result){
        	if (result.datas.error) {
        		return ;
        	}
    ...
    function cancelOrderId(order_id) {
        $.ajax({
            type:"post",
            url:ApiUrl+"/index.php?model=member_vr_order&fun=order_cancel",
    ...
    function toSend(){
    	...
    	$.ajax({
            type:"post",
            url:ApiUrl+"/index.php?model=member_vr_order&fun=resend",
