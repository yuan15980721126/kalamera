...
<div id="login">
<div id="login_image">
  <img src="/skins/default/img/Enroll/login_03.jpg" />
</div>

<div class="nc-login-layout">
  <div class="openid"><span class="avatar"><img src="<?php echo $output['headimgurl'];?>" /></span><span>您使用微信账号<a href="#register_form"><?php echo $output['user_info']['nickname']; ?></a>Registered successfully，系统为您随机新建商城用户名<br/>
    ...
    <div class="nc-wx-mode">
      ...
      <div id="tabs_container" class="tabs-container">
        <div id="register" class="tabs-content">
          <form name="register_form" id="register_form" class="nc-login-form" method="post" action="index.php?model=connect_wx&fun=edit_info">
        ...
        success: function(label) {
            ...
            rules: {
                ...
                email: {
                    ...
                    email: true,
                    remote: {
                        url: 'index.php?model=login&fun=check_email',
                        type: 'get',
                        data: {
                            email: function() {
                                return $('#email').val();
