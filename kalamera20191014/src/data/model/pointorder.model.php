...
class pointorderModel extends Model{
    ...
    public function getPointOrderStateBySign(){
        ...
        $pointorderstate_arr['waitship'] = array(20,'To be shipped');
    ...
    public function getPointOrderState($order_state){
        ...
        $pointorderstate_arr[20] = array('waitship','To be shipped');
    ...
    public function createOrder($post_arr, $pointprod_arr, $member_info){
        // echo "<pre>";
        // print_R($post_arr);
        // print_R($pointprod_arr);
        // print_R($member_info);
        // die;
        //验证是否存在收货地址
        $address_options = intval($post_arr['address_id']);
