...
class messageModel extends Model {
     ...
     * 更新系统消息
     */
    public function updateSystemMessage($param,$condition){
        if(empty($param)) {
            return false;
        }
        //得到条件语句
    ...
    private function getCondition($condition_array){
        ...
        //已删除
        if($condition_array['del_member_id'] != ''){

            // print_R($tmp_delid_arr);die;
            // $condition_sql  .= " and message.del_member_id not in (".$condition_array['del_member_id'].")";
            $condition_sql  .= " and message.del_member_id not like '%,{$condition_array['del_member_id']},%' ";
        }
