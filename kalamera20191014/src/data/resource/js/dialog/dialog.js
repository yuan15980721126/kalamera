        ...
        switch(type){
            ...
            case 'message':
                ...
                switch (type){
                    ...
                    break;
                    case 'confirm':
                        var yes_button_name = "Sure";
                        var no_button_name = "cancel";
...
function showDialog(msg, mode, t, func, cover, funccancel, leftmsg, confirmtxt, canceltxt, closetime, locationtime) {
	...
	if(closetime) {
		leftmsg =  'The window closes after'+ closetime +'seconds';
		showDialogST = setTimeout(closefunc, closetime * 1000);
		showconfirm = 0;
	}
	locationtime = isUndefined(locationtime) ? '' : locationtime;
	if(locationtime) {
		leftmsg = 'Page jump after'+ locationtime +'seconds'
	...
	s += t ? t : '<span class="dialog_title_icon">Prompt information</span>';
...
function showSucc(msg) {
	...
	msg = msg.replace(p, '');
	if(msg !== '') {
		showDialog(msg, 'succ', 'Prompt information', null, true, null, '', '', '', 3);
	}
}
