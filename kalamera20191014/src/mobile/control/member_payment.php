...
class member_paymentControl extends mobileMemberControl {
    ...
    public function __construct() {
        ...
        if($_GET['fun'] != 'payment_list' && !$_POST['payment_code']) {
            $payment_code = 'alipay';

            if(in_array($_GET['fun'], array('wx_app_pay', 'wx_app_pay3', 'wx_app_vr_pay', 'wx_app_vr_pay3'), true)) {
                $payment_code = 'wxpay';
            }
            else if (in_array($_GET['fun'],array('alipay_native_pay','alipay_native_vr_pay'),true)) {
