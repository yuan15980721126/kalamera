...
//         Tpl::output('help_list',$help_list);
     ...
     */
		...
		if($distribution_info){
			showmessage('You have already submitted your application. Please do not submit it again'); //您已经提交了申请，请勿重复提交
		}else{
			$param = array();
			...
			if($result){
				showmessage('The application is pending for review');//申请中，请等待审核
			}else{
				showmessage('Application failed');//申请提交失败
			}
		}	
	}
