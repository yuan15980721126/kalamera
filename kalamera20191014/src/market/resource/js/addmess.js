...
$(function(){
	...
	check_tuwen(1);
	//var url = "/biz.php?ctl=wechat&model=showmess";
	var url = "index.php?model=seller_wechat&fun=showmess";
...
function btnsave(num,count){
	...
	if(ktype==1){
		...
		//var url = "/biz.php?ctl=wechat&model=addmess";
		var url = "index.php?model=seller_wechat&fun=addmess";
