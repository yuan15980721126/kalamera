...
$(function(){
    ...
    /* 商品图片ajax上传 */
    var url = SITEURL + '/index.php?model=store_setting&fun=silde_image_upload';
    ...
    $('a[nctype="del"]').unbind().click(
        function() {
            ...
            $.getJSON('index.php?model=store_setting&fun=dorp_img', {file_id : file_id, img_src : img_src}, function(data) {
	...
	(
		{
			...
			success: function (data, status)
			{
				...
				$.getScript(SHOP_RESOURCE_SITE_URL+"/js/jquery.flexslider-min.js");
				$.getScript(SHOP_RESOURCE_SITE_URL+"/js/store_slide.js");
			},
