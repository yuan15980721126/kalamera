$(function(){
    ...
    $('#goods_image').fileupload({
        dataType: 'json',
        url: SITEURL + '/index.php?model=store_goods_add&fun=image_upload&upload_type=uploadedfile',
    ...
    /* 商品活性成分图片ajax上传 */
    $('.ingred_file').fileupload({
        dataType: 'json',
        url: SITEURL + '/index.php?model=store_goods_add&fun=image_upload',
        formData: {name:'goods_image'},
        add: function (e,data) {
    ...
    $('a[nctype="mb_add_img"]').click(function(){
        $('a[nctype="meat_cancel"]').click();
        $('div[nctype="mea_img"]').show().load('index.php?model=store_album&fun=pic_list&item=mobile');
    });
    // 关闭 图片选择
    ...
    $('div[nctype="mobile_pannel"]').on('click', 'a[nctype="mp_rpl"]', function(){
        $('a[nctype="meat_cancel"]').click();
        $('div[nctype="mea_img"]').show().load('index.php?model=store_album&fun=pic_list&item=mobile&type=replace');
    });
    // 插图图片
