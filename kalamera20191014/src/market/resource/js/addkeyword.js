...
function zsc_show(id){
	...
	if(zsc_class!='add'){
		...
		var url = "index.php?model=seller_wechat&fun=addkeyword_ajax&kid="+zsc_id;
		//var url = "/biz.php?ctl=wechat&model=addkeyword_ajax&kid="+zsc_id;
...
function btnsave(num,count){
	...
	if(ktype==1){
		...
		if(count==0){
			//var url = "/biz.php?ctl=wechat&model=keyword_index&fun=add";
			var url = "index.php?model=seller_wechat&fun=keyword_index&opt=add";
			...
			//var url = "/biz.php?ctl=wechat&model=keyword_index&fun=update";
			var url = "index.php?model=seller_wechat&fun=keyword_index&opt=update";
			var kid = $('#zsc_iid').val();
...
function zscdel(num){
	...
	var url = "index.php?model=seller_wechat&fun=keyword_index&opt=del";
	//var url = "/biz.php?ctl=wechat&model=keyword_index&fun=del";
	...
	$("input[name='"+file_id+"']").bind("change",function(){			
		...
		$(obj).parent().find(".fileuploading").addClass("show");
		  $.ajaxFileUpload
		   (
			   {
				    //url:APP_ROOT+'/index.php?ctl=avatar&model=upload&uid='+uid,
					url:"index.php?model=seller_wechat&fun=upload_fm",
					//url:APP_ROOT+'/biz.php?ctl=wechat&model=upload_fm',
				    secureuri:false,
