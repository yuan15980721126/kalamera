...
$(function(){
	...
	var act = "<?php echo trim($_GET['model']); ?>";
	var op  = "<?php echo trim($_GET['fun']) != ''?trim($_GET['fun']):'index'; ?>";
	$.getJSON("index.php?model=show_store&fun=ajax_flowstat_record",{store_id:store_id,goods_id:goods_id,act_param:act,op_param:op});
});
</script> 
