  ...
  <div class="ncs-main-container">
    ...
    <div class="ncs-goodslist-bar">
      ...
      <form id="" name="searchShop" method="get" action="index.php" >
        <input type="hidden" name="model" value="show_store" />
        <input type="hidden" name="fun" value="goods_all" />
        <input type="hidden" name="store_id" value="<?php echo $output['store_info']['store_id'];?>" />
        <input type="text" class="text w120" name="inkeyword" value="<?php echo $_GET['inkeyword'];?>" placeholder="search店内商品">
