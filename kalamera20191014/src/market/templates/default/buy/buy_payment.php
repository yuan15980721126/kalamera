...
<div id="delivery">
    <div class="delivery_content">
        <!-- <div id="select_f">
            <div class="s_head">选择配送方式</div>
            <div class="dev_check">
                <input type="checkbox" name="dev_check" /><label>酒具专用快递</label>
            </div>
            <div class="dev_check">
                <input type="checkbox" name="dev_check" /><label>酒柜专用物流</label>
            </div>
            <div class="dev_check">
                <input type="checkbox" name="dev_check" /><label>酒柜专用物流</label>
            </div>
        ...
        <div id="pay">
            ...
            <div id="pay_style">
                <div id="zfb"></div> 
                <div id="wx"></div>
                <input type="hidden" value="online" name="payment_type" id="payment_type_online">
                <input type="hidden" value="online" name="payment_codeid" id="payment_codeid">
            </div>
            <!-- <div id="save">保存配送及支付方式</div> -->
        </div>    
