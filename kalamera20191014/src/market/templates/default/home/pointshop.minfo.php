...
<div class="ncp-member-point">
  <dl style="border-left: none 0;">
    <a href="<?php echo MEMBER_SITE_URL;?>/index.php?model=member_points" target="_blank">
  ...
  <dl>
    <a href="<?php echo MEMBER_SITE_URL;?>/index.php?model=member_voucher&fun=index" target="_blank">
  ...
  <dl>
    <a href="<?php echo MEMBER_SITE_URL;?>/index.php?model=member_pointorder&fun=orderlist" target="_blank">
...
<?php if (C('pointprod_isuse')==1){?>
<div class="ncp-memeber-pointcart"> <a href="index.php?model=pointcart" class="btn">礼品兑换购物车<?php if ($output['pointcart_count'] > 0){?><em><?php echo $output['pointcart_count']; ?></em><?php } ?></a></div>
<?php }?>
