...
<div class="nch-container wrapper">
    <div class="ncp-voucher w400 mt20 mb20">
      <div class="info">
       <!--  <a href="<?php echo urlShop('show_store', 'index', array('store_id'=>$output['template_info']['voucher_t_store_id']));?>" class="store" target="_blank"><?php echo $output['template_info']['voucher_t_storename'];?></a>
      ...
      <dl class="value">
        ...
        <dd>
        <?php echo $output['template_info']['voucher_t_giveout'];?></em>人兑换
      ...
      <div class="button"><a href="javascript:void(0);" id="getvoucherbtn" data-param='{"tid":"<?php echo $output['template_info']['voucher_t_id'];?>"}' class="ncbtn ncbtn-grapefruit" style="background-color: #c1b497;">确认领取</a></div>
    </div>
</div>
<script type="text/javascript">
$(document).ready(function(){
	$("#getvoucherbtn").click(function(){
		ajaxget('index.php?model=voucher&fun=getvouchersave&tid=<?php echo $output['template_info']['voucher_t_id'];?>');
	});
});
</script>