...
<div class="ncsc-form-default">
  <form method="post" action="index.php?model=store_setting&fun=store_mobile" enctype="multipart/form-data" id="my_store_form">
...
$(function() {
    ...
    $('input.input-file').change(function() {
        ...
        $.ajaxFileUpload({
            url: 'index.php?model=store_setting&fun=store_mb_sliders',
            secureuri: false,
            fileElementId: id,
            dataType: 'json',
            data: {id: id},
    ...
    $("a[data-slider-drop]").click(function() {
        ...
        $.getJSON('index.php?model=store_setting&fun=store_mb_sliders_drop', {id: id}, function(d) {
            if (!d.success) {
                alert(d.error);
                return;
            }
