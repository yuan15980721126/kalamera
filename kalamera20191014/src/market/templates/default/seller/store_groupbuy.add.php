...
<div class="ncsc-form-default">
  <form id="add_form" action="index.php?model=store_groupbuy&fun=groupbuy_save" method="post" enctype="multipart/form-data">
    <dl>
          ...
          <table class="search-form">
              <tr>
                  ...
                  <td class="w70 tc">
                    ...
                    <td class="w10"></td>
                    <td>
                        <p class="hint">不输入名称直接search将显示店内所有普通商品，特殊商品不能参加。</p>
                    </td>
                </tr>
            </table>
