  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td><?php
				...
				?></td>
      <td class="nscs-table-handle"><span><a href="index.php?model=store_complain&fun=complain_show&complain_id=<?php echo $val['complain_id'];?>" class="btn-bittersweet"><i class="icon-eye-open"></i>
