  ...
  <div class="ncsc-order-info">
    <div class="ncsc-order-details">
      ...
      <div class="content">
        <dl>
          ...
          <dd><?php echo str_replace('---','  ',$output['order_info']['extend_order_common']['reciver_name']);?>,&nbsp; <?php echo @$output['order_info']['extend_order_common']['reciver_info']['phone'];?>,&nbsp; <?php echo @$output['new_address'];?><?php echo $output['order_info']['extend_order_common']['reciver_info']['dlyp'] ? '[自提服务站]' : '';?></dd>
        </dl>
          <dl>
              <dt>邮政编码：</dt>
    ...
    <div class="ncsc-order-condition">
      ...
      <ul>
        ...
        <li>2. 可以在<a href="index.php?model=store_evaluate&fun=list" class="ncbtn-mini">评价管理</a>查看详细内容。</li>
      </ul>
    </div>
    <?php } else { ?>
    <div class="ncsc-order-condition">
        ...
        <tr class="bd-line">
          ...
          <td class="tl"><dl class="goods-name">
              ...
              <dd>
                ...
                退款单号：<a target="_blank" href="index.php?model=store_refund&fun=view&refund_id=<?php echo $output['refund_all']['refund_id'];?>"><?php echo $output['refund_all']['refund_sn'];?></a>
                <?php }else if($goods['extend_refund']['refund_type'] == 1) {?>
                退款单号：<a target="_blank" href="index.php?model=store_refund&fun=view&refund_id=<?php echo $goods['extend_refund']['refund_id'];?>"><?php echo $goods['extend_refund']['refund_sn'];?></a></dd>
              <?php }else if($goods['extend_refund']['refund_type'] == 2) {?>
              退货单号：<a target="_blank" href="index.php?model=store_return&fun=view&return_id=<?php echo $goods['extend_refund']['refund_id'];?>"><?php echo $goods['extend_refund']['refund_sn'];?></a>
              </dd>
              <?php } ?>
            </dl></td>
      ...
      <tfoot>
        ...
        <tr>
          <td colspan="20">
              ...
              <dl class="freight">
                  <dd>
                      <span>税费百分比<?php echo $lang['nc_colon'].ncPriceFormat($output['order_info']['tax']);?>%</span>
                  </dd>
              </dl>
              <?php } ?>
              ...
              <dl class="freight">
                  <dd>
                          <span>(税费<?php echo $lang['nc_colon'].'$'.ncPriceFormat($output['order_info']['tax_payment']);?>)</span>
                  </dd>
              </dl>
              <?php } ?>
