          ...
          <div class="tabs">
            ...
            <div id="panel-1" class="ui-tabs-panel">
              ...
              <div class="hr8">
                ...
                <a class="ncbtn mt5" nctype="show_desc" href="index.php?model=store_album&fun=pic_list&item=des"><i class="icon-picture"></i><?php echo $lang['store_goods_album_insert_users_photo'];?></a> <a href="javascript:void(0);" nctype="del_desc" class="ncbtn mt5" style="display: none;"><i class=" icon-circle-arrow-up"></i>关闭相册</a> </div>
              <p id="des_demo"></p>
            </div>
