...
<div class="tabmenu">
  ...
  <a href="javascript:void(0)" class="ncbtn ncbtn-mint" onclick="go('index.php?model=store_account_group&fun=group_add');" title="添加账号"><i class="icon-group"></i>添加组</a> </div>
