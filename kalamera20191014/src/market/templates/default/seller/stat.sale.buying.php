...
<div class="alert mt10" style="clear:both;">
	<ul class="mt5">
        ...
        <li>3、“购买时段分布”统计图展示符合search条件的有效订单在各个时间段的分布情况，为工作时间的合理安排提供依据</li>
    </ul>
</div>
<form method="get" action="index.php" target="_self">
  <table class="search-form">
    <input type="hidden" name="model" value="statistics_sale" />
    <input type="hidden" name="fun" value="buying" />
    <tr>
    	<td class="tr">
    		<div class="fr">
...
<div class="alert alert-info"><strong>客单价分布</strong>（<a href="index.php?model=statistics_general&fun=orderprange" target="_blank">设置价格区间</a>）</div>
  ...
  <tbody>
	<tr id="row_0">
		<td class="tl">
    		...
    		<?php } else { ?>
    		<div class="tc h50 mt10">查看分布情况前，请先设置价格区间。<a href="index.php?model=statistics_general&fun=orderprange" target="_blank">马上设置</a></div>
    		<?php }?>
		</td>
	</tr>
  </tbody>
