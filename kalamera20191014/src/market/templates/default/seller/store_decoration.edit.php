...
<div id="dialog_module_goods" class="eject_con dialog-decoration-edit" style="display:none;">
  <div class="alert">
    <ul>
      <li>1. search店铺内在售商品并“选择添加”，设置窗口上部将出现已选择的商品列表，也可对其进行“取消选择”操作，点击保存设置后生效。</li>
  ...
  <div class="decoration-search-goods">
    <div class="search-bar">输入商品关键字：
      ...
      <a id="btn_module_goods_search" class="ncbtn" href="javascript:void(0);">search</a><span class="ml10 orange">小提示： 留空search显示店铺全部在售商品，每页显示10个。</span></div>
