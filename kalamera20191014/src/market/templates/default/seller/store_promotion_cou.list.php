...
<form method="get">
  <table class="search-form">
    <input type="hidden" name="model" value="store_promotion_cou" />
    <input type="hidden" name="fun" value="cou_list" />
    <tr>
      <td>&nbsp;</td>
      <th>状态</th>
  ...
  <tbody id="cou_list">
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle tr">
          ...
          <span>
              <a href="index.php?model=store_promotion_cou&fun=cou_edit&cou_id=<?php echo $val['id'];?>" class="btn-bluejeans">
                  <i class="icon-edit"></i>
