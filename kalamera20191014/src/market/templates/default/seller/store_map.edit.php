<div class="eject_con">
  ...
  <form id="post_form" method="post" action="index.php?model=store_map&fun=edit_map&map_id=<?php echo $output['map']['map_id']; ?>">
    <input type="hidden" name="form_submit" value="ok" />
    <dl>
      <dt><i class="required">*</i>实体Shop name<?php echo $lang['nc_colon'];?></dt>
      <dd>
...
$(function(){
    $('#post_form').validate({
        ...
        messages : {
            name_info : {
                required : '<i class="icon-exclamation-sign"></i>实体Shop name不能为空'
            },
            address_info  : {
