          ...
          <dd>
            ...
            <?php echo $lang['complain_pic_none'];?>
                <?php if((intval($output['complain_info']['complain_state']) < 99)) { ?>
                    ...
                    <form style="display: none;" id="post_add_pic_form" method="post" action="index.php?model=member_complain&fun=complain_add_pic&complain_id=<?php echo $output['complain_info']['complain_id']; ?>" enctype="multipart/form-data">
