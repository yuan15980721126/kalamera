...
<div class="header-wrap">
  <header class="public-head-layout wrapper">
	...
	<!--商品和店铺-->
      <!--<ul class="tab">
        <li title="请输入您要search的商品关键字" model="search" class="current">商品</li>
        <li title="请输入您要search的店铺关键字" model="store_list">店铺</li>
      </ul>-->
      <form class="search-form" method="get" action="<?php echo SHOP_SITE_URL;?>">
        <input type="hidden" value="search" id="search_act" name="model">
         <input placeholder="请输入您要search的商品关键字" name="keyword" id="keyword" type="text" class="input-text" value="<?php echo $_GET['keyword'];?>" maxlength="60" x-webkit-speech lang="zh-CN" onwebkitspeechchange="foo()" x-webkit-grammar="builtin:search" />
